...
.Ltext0:
	...
	.align	2
	.type	R_CopyInterpToOld, %function
R_CopyInterpToOld:
.LFB7:
	.file 1 "c:/devl/prboom3ds/src/r_fps.c"
	.loc 1 118 0
	.cfi_startproc
...
.LVL0:
	...
	mov	r2, r0, asl #3
	ldr	r3, [ip]
	ldrb	r1, [r3, r0, asl #3]	@ zero_extendqisi2
	add	r3, r3, r2
	cmp	r1, #5
...
.L11:
	...
	.cfi_endproc
.LFE7:
	.size	R_CopyInterpToOld, .-R_CopyInterpToOld
	.align	2
	.type	R_StopInterpolation.part.0, %function
R_StopInterpolation.part.0:
.LFB20:
	.loc 1 258 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 0
...
.L16:
	...
	cmp	ip, r1
	bne	.L15
	ldrb	ip, [lr, r2, asl #3]	@ zero_extendqisi2
	cmp	ip, r0
	bne	.L15
	.loc 1 270 0
	ldr	r1, [r6, #4]
...
.L20:
	...
	.cfi_endproc
.LFE20:
	.size	R_StopInterpolation.part.0, .-R_StopInterpolation.part.0
	.align	2
	.type	R_InterpolationGetData, %function
R_InterpolationGetData:
.LFB17:
	.loc 1 355 0
	.cfi_startproc
...
.LBE31:
	.cfi_endproc
.LFE17:
	.size	R_InterpolationGetData, .-R_InterpolationGetData
	.align	2
	.type	R_SetInterpolation.part.2, %function
R_SetInterpolation.part.2:
.LFB22:
	.loc 1 234 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 0
...
.L53:
	...
	.cfi_endproc
.LFE22:
	.size	R_SetInterpolation.part.2, .-R_SetInterpolation.part.2
	.global	__aeabi_i2f
	.global	__aeabi_fmul
	.align	2
	.global	R_InitInterpolation
	.type	R_InitInterpolation, %function
R_InitInterpolation:
.LFB4:
	.loc 1 70 0
	.cfi_startproc
...
.L57:
	...
	.cfi_endproc
.LFE4:
	.size	R_InitInterpolation, .-R_InitInterpolation
	.align	2
	.global	R_InterpolateView
	.type	R_InterpolateView, %function
R_InterpolateView:
.LFB5:
	.loc 1 84 0
	.cfi_startproc
...
.L66:
	...
	.cfi_endproc
.LFE5:
	.size	R_InterpolateView, .-R_InterpolateView
	.align	2
	.global	R_ResetViewInterpolation
	.type	R_ResetViewInterpolation, %function
...
.L69:
	...
	.cfi_endproc
.LFE6:
	.size	R_ResetViewInterpolation, .-R_ResetViewInterpolation
	.align	2
	.global	R_UpdateInterpolations
	.type	R_UpdateInterpolations, %function
...
.L78:
	...
	.cfi_endproc
.LFE10:
	.size	R_UpdateInterpolations, .-R_UpdateInterpolations
	.align	2
	.global	R_StopAllInterpolations
	.type	R_StopAllInterpolations, %function
...
.L85:
	...
	.cfi_endproc
.LFE13:
	.size	R_StopAllInterpolations, .-R_StopAllInterpolations
	.align	2
	.global	R_DoInterpolations
	.type	R_DoInterpolations, %function
R_DoInterpolations:
.LFB14:
	.loc 1 299 0
	.cfi_startproc
...
.LBE47:
	.cfi_endproc
.LFE14:
	.size	R_DoInterpolations, .-R_DoInterpolations
	.align	2
	.global	R_RestoreInterpolations
	.type	R_RestoreInterpolations, %function
...
.LBE53:
	.cfi_endproc
.LFE15:
	.size	R_RestoreInterpolations, .-R_RestoreInterpolations
	.align	2
	.global	R_ActivateSectorInterpolations
	.type	R_ActivateSectorInterpolations, %function
...
.L154:
	...
	.cfi_endproc
.LFE16:
	.size	R_ActivateSectorInterpolations, .-R_ActivateSectorInterpolations
	.align	2
	.global	R_ActivateThinkerInterpolations
	.type	R_ActivateThinkerInterpolations, %function
R_ActivateThinkerInterpolations:
.LFB18:
	.loc 1 413 0
	.cfi_startproc
...
.LBE65:
	.cfi_endproc
.LFE18:
	.size	R_ActivateThinkerInterpolations, .-R_ActivateThinkerInterpolations
	.align	2
	.global	R_StopInterpolationIfNeeded
	.type	R_StopInterpolationIfNeeded, %function
R_StopInterpolationIfNeeded:
.LFB19:
	.loc 1 433 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 16
...
.LBE73:
	.cfi_endproc
.LFE19:
	.size	R_StopInterpolationIfNeeded, .-R_StopInterpolationIfNeeded
	.global	interpolations_max
	.comm	WasRenderedInTryRunTics,4,4
	.comm	original_view_vars,20,4
	.comm	tic_vars,20,4
	.global	movement_smooth
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
	.type	curipos, %object
...
oldipos:
	.space	4
	.type	numinterpolations, %object
	.size	numinterpolations, 4
numinterpolations:
	.space	4
	.type	bakipos, %object
	.size	bakipos, 4
bakipos:
	.space	4
	.type	interpolations_max, %object
	.size	interpolations_max, 4
interpolations_max:
	.space	4
	.type	movement_smooth, %object
	.size	movement_smooth, 4
movement_smooth:
	.space	4
	.type	NoInterpolateView, %object
	.size	NoInterpolateView, 4
NoInterpolateView:
	.space	4
	.type	didInterp, %object
	.size	didInterp, 4
didInterp:
	.space	4
	.text
.Letext0:
	...
	.file 18 "c:/devl/prboom3ds/src/r_fps.h"
	.file 19 "c:/devl/prboom3ds/src/r_state.h"
	.file 20 "c:/devl/prboom3ds/src/r_demo.h"
...
.LASF303:
	.ascii	"S_BLOOD3\000"
.LASF1813:
	.ascii	"c:/devl/prboom3ds/src/r_fps.c\000"
.LASF1254:
	.ascii	"misc1\000"
.LASF1255:
	.ascii	"misc2\000"
...
.LASF1775:
	.ascii	"R_InterpolationGetData\000"
.LASF1655:
...
.LASF1764:
	.ascii	"INTERP_SectorCeiling\000"
.LASF837:
...
.LASF255:
	.ascii	"S_DSGUN10\000"
.LASF1768:
	.ascii	"INTERP_CeilingPanning\000"
.LASF47:
...
.LASF1116:
	.ascii	"S_MEAT5\000"
.LASF1769:
	.ascii	"interpolation_type_e\000"
.LASF1749:
	.ascii	"control\000"
.LASF228:
