...
.Ltext0:
	...
	.align	2
	.global	R_ClearDrawSegs
	.type	R_ClearDrawSegs, %function
R_ClearDrawSegs:
.LFB4:
	.file 1 "c:/devl/prboom3ds/src/r_bsp.c"
	.loc 1 64 0
	.cfi_startproc
...
.LVL15:
	...
	streq	r3, [r6, #12]
	.loc 1 235 0
	streqh	ip, [r6, #186]	@ movhi
	.loc 1 236 0
	streq	r0, [r6, #168]
	.loc 1 237 0
	streq	r1, [r6, #172]
	.loc 1 239 0
	strneh	r2, [r6, #186]	@ movhi
	.loc 1 240 0
	strne	r1, [r6, #168]
	.loc 1 241 0
	strne	r3, [r6, #172]
...
.LBE3:
	.cfi_endproc
.LFE8:
	.size	R_FakeFlat, .-R_FakeFlat
	.align	2
	.global	R_RenderBSPNode
...
.L95:
	...
	str	r7, [r1]
	bne	.L96
	ldrb	r8, [r7, #84]	@ zero_extendqisi2
.L97:
	.loc 1 395 0
	tst	r8, #8
	bne	.L92
...
.LFE12:
	...
	.comm	solidcol,400,4
	.comm	maxdrawsegs,4,4
	.comm	drawsegs,4,4
	.comm	ds_p,4,4
	.comm	backsector,4,4
	.comm	frontsector,4,4
	.comm	linedef,4,4
	.comm	sidedef,4,4
	.comm	curline,4,4
	.section	.rodata
...
checkcoord:
	...
	.align	2
	.set	.LANCHOR1,. + 0
	.type	tempsec.8458, %object
	.size	tempsec.8458, 196
tempsec.8458:
	.space	196
	.text
.Letext0:
	...
	.file 20 "c:/devl/prboom3ds/src/r_plane.h"
	.file 21 "c:/devl/prboom3ds/src/r_segs.h"
...
.LASF1251:
	.ascii	"MT_FIRE\000"
.LASF1724:
	.ascii	"c:/devl/prboom3ds/src/r_bsp.c\000"
.LASF1659:
	.ascii	"pad1\000"
.LASF1660:
	.ascii	"pad2\000"
...
.LASF93:
	.ascii	"SPR_FBXP\000"
.LASF1681:
	.ascii	"R_RecalcLineFlags\000"
.LASF1682:
	.ascii	"R_ClipWallSegment\000"
.LASF892:
