# 1 "c:/devl/prboom3ds/src/p_maputl.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_maputl.c"
# 37 "c:/devl/prboom3ds/src/p_maputl.c"
...
# 38 "c:/devl/prboom3ds/src/p_maputl.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_maputl.c" 2
...
# 40 "c:/devl/prboom3ds/src/p_maputl.c" 2
...
# 41 "c:/devl/prboom3ds/src/p_maputl.c" 2
...
# 42 "c:/devl/prboom3ds/src/p_maputl.c" 2
...
# 43 "c:/devl/prboom3ds/src/p_maputl.c" 2
...
int __attribute__((pure)) P_PointOnLineSide(fixed_t x, fixed_t y, const line_t *line)
{
  return
    ...
    FixedMul(y-line->v1->y, line->dx>>16) >=
    FixedMul(line->dy>>16, x-line->v1->x);
}
# 80 "c:/devl/prboom3ds/src/p_maputl.c"
int __attribute__((pure)) P_BoxOnLineSide(const fixed_t *tmbox, const line_t *ld)
{
  switch (ld->slopetype)
    {
...
static int __attribute__((pure)) P_PointOnDivlineSide(fixed_t x, fixed_t y, const divline_t *line)
{
  return
...
# 143 "c:/devl/prboom3ds/src/p_maputl.c"
fixed_t __attribute__((pure)) P_InterceptVector2(const divline_t *v2, const divline_t *v1)
{
  fixed_t den;
...
# 172 "c:/devl/prboom3ds/src/p_maputl.c"
fixed_t opentop;
fixed_t openbottom;
fixed_t openrange;
fixed_t lowfloor;
...
void P_LineOpening(const line_t *linedef)
{
  if (linedef->sidenum[1] == ((unsigned short)-1))
    {
      openrange = 0;
      return;
    }
...
# 224 "c:/devl/prboom3ds/src/p_maputl.c"
void P_UnsetThingPosition (mobj_t *thing)
{
  if (!(thing->flags & (uint_64_t)(0x0000000000000008)))
    {
      ...
      if ((*sprev = snext))
        snext->sprev = sprev;
# 253 "c:/devl/prboom3ds/src/p_maputl.c"
      sector_list = thing->touching_sectorlist;
      thing->touching_sectorlist = ((void *)0);
    }

  if (!(thing->flags & (uint_64_t)(0x0000000000000010)))
    {
# 270 "c:/devl/prboom3ds/src/p_maputl.c"
      mobj_t *bnext, **bprev = thing->bprev;
      if (bprev && (*bprev = bnext = thing->bnext))
        bnext->bprev = bprev;
    }
}
# 284 "c:/devl/prboom3ds/src/p_maputl.c"
void P_SetThingPosition(mobj_t *thing)
{
  ...
  if (!(thing->flags & (uint_64_t)(0x0000000000000008)))
    {
      ...
      thing->sprev = link;
      *link = thing;
# 314 "c:/devl/prboom3ds/src/p_maputl.c"
  ...
  if (!(thing->flags & (uint_64_t)(0x0000000000000010)))
    {
      ...
      int blockx = (thing->x - bmaporgx)>>(16 +7);
      int blocky = (thing->y - bmaporgy)>>(16 +7);
      if (blockx>=0 && blockx < bmapwidth && blocky>=0 && blocky < bmapheight)
        ...
        *link = thing;
        ...
        thing->bnext = ((void *)0), thing->bprev = ((void *)0);
    }
}
# 360 "c:/devl/prboom3ds/src/p_maputl.c"
boolean P_BlockLinesIterator(int x, int y, boolean func(line_t*))
{
  int offset;
  const long *list;
...
divline_t trace;
# 437 "c:/devl/prboom3ds/src/p_maputl.c"
boolean PIT_AddLineIntercepts(line_t *ld)
{
  ...
  if (trace.dx > (1<<16)*16 || trace.dy > (1<<16)*16 ||
      trace.dx < -(1<<16)*16 || trace.dy < -(1<<16)*16)
    {
...
# 539 "c:/devl/prboom3ds/src/p_maputl.c"
boolean P_TraverseIntercepts(traverser_t func, fixed_t maxfrac)
{
  intercept_t *in = ((void *)0);
  int count = intercept_p - intercepts;
  while (count--)
    {
      fixed_t dist = 2147483647;
      intercept_t *scan;
...
# 568 "c:/devl/prboom3ds/src/p_maputl.c"
boolean P_PathTraverse(fixed_t x1, fixed_t y1, fixed_t x2, fixed_t y2,
                       int flags, boolean trav(intercept_t *))
{
  fixed_t xt1, yt1;
  ...
  if (!((x1-bmaporgx)&((128*(1<<16))-1)))
    x1 += (1<<16);

  if (!((y1-bmaporgy)&((128*(1<<16))-1)))
    y1 += (1<<16);
