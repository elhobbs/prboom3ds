# 1 "c:/devl/prboom3ds/src/p_checksum.c"
...
# 2 "c:/devl/prboom3ds/src/p_checksum.c" 2
...
# 3 "c:/devl/prboom3ds/src/p_checksum.c" 2
...
# 4 "c:/devl/prboom3ds/src/p_checksum.c" 2
...
# 5 "c:/devl/prboom3ds/src/p_checksum.c" 2
...
# 7 "c:/devl/prboom3ds/src/p_checksum.c" 2
# 1 "c:/devl/prboom3ds/src/md5.h" 1
# 31 "c:/devl/prboom3ds/src/md5.h"
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\inttypes.h" 1 3
# 17 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\inttypes.h" 3
...
# 18 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\inttypes.h" 2 3

# 1 "c:\\devkitpro\\devkitarm\\lib\\gcc\\arm-none-eabi\\4.9.2\\include\\stddef.h" 1 3 4
# 20 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\inttypes.h" 2 3
# 280 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\inttypes.h" 3
typedef struct {
  intmax_t quot;
  intmax_t rem;
} imaxdiv_t;
...
# 32 "c:/devl/prboom3ds/src/md5.h" 2
...
# 8 "c:/devl/prboom3ds/src/p_checksum.c" 2
...
# 55 "c:/devl/prboom3ds/src/z_zone.h"
...
# 9 "c:/devl/prboom3ds/src/p_checksum.c" 2
...
# 10 "c:/devl/prboom3ds/src/p_checksum.c" 2
...
void P_RecordChecksum(const char *file) {
    ...
    if(0 == strncmp("-",file,((1)<(fnsize)?(1):(fnsize))))
        outfile = (_impure_ptr->_stdout);
    else {
...
static void p_checksum_cleanup(void) {
    if (outfile && (outfile != (_impure_ptr->_stdout)))
        fclose(outfile);
}
