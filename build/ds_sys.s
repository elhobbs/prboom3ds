...
.Ltext0:
	...
	.align	2
	.type	I_GetTime_FastDemo, %function
I_GetTime_FastDemo:
.LFB16:
	.file 1 "c:/devl/prboom3ds/arm9/source/ds_sys.c"
	.loc 1 142 0
	.cfi_startproc
...
.L2:
	...
	.cfi_endproc
.LFE16:
	.size	I_GetTime_FastDemo, .-I_GetTime_FastDemo
	.align	2
	.global	I_GetTime_RealTime
	.type	I_GetTime_RealTime, %function
I_GetTime_RealTime:
.LFB19:
	.loc 1 162 0
	.cfi_startproc
...
.L8:
	...
	.cfi_endproc
.LFE19:
	.size	I_GetTime_RealTime, .-I_GetTime_RealTime
	.align	2
	.type	I_GetTime_Scaled, %function
I_GetTime_Scaled:
.LFB15:
	.loc 1 137 0
	.cfi_startproc
...
.L12:
	...
	.cfi_endproc
.LFE15:
	.size	I_GetTime_Scaled, .-I_GetTime_Scaled
	.align	2
	.type	I_GetTime_Error, %function
I_GetTime_Error:
.LFB18:
	.loc 1 154 0
	.cfi_startproc
...
.L16:
	...
	.cfi_endproc
.LFE18:
	.size	I_GetTime_Error, .-I_GetTime_Error
	.align	2
	.global	GetTicks
...
.LBE31:
.LBE30:
	.loc 1 29 0 is_stmt 1 discriminator 1
	cmp	r4, r0
	bhi	.L21
	.loc 1 30 0
	ldmfd	sp!, {r4, pc}
...
.LFE7:
	.size	Pause, .-Pause
	.align	2
	.global	I_StartDisplay
	.type	I_StartDisplay, %function
I_StartDisplay:
.LFB8:
	.loc 1 37 0
	.cfi_startproc
...
.L30:
	...
	.cfi_endproc
.LFE8:
	.size	I_StartDisplay, .-I_StartDisplay
	.align	2
	.global	I_EndDisplay
	.type	I_EndDisplay, %function
I_EndDisplay:
.LFB9:
	.loc 1 47 0
	.cfi_startproc
...
.L34:
	...
	.cfi_endproc
.LFE9:
	.size	I_EndDisplay, .-I_EndDisplay
	.align	2
	.global	I_Read
	.type	I_Read, %function
I_Read:
.LFB10:
	.loc 1 53 0
	.cfi_startproc
...
.L41:
	...
	.cfi_endproc
.LFE11:
	.size	I_Filelength, .-I_Filelength
	.align	2
	.global	HasTrailingSlash
	.type	HasTrailingSlash, %function
HasTrailingSlash:
.LFB12:
	.loc 1 67 0
	.cfi_startproc
...
.LVL23:
	...
	.cfi_endproc
.LFE12:
	.size	HasTrailingSlash, .-HasTrailingSlash
	.align	2
	.global	I_uSleep
	.type	I_uSleep, %function
I_uSleep:
.LFB14:
	.loc 1 128 0
	.cfi_startproc
...
.L46:
	...
	.cfi_endproc
.LFE14:
	.size	I_uSleep, .-I_uSleep
	.align	2
	.global	I_GetRandomTimeSeed
	.type	I_GetRandomTimeSeed, %function
I_GetRandomTimeSeed:
.LFB17:
	.loc 1 148 0
	.cfi_startproc
...
.LBE38:
	...
	.cfi_endproc
.LFE17:
	.size	I_GetRandomTimeSeed, .-I_GetRandomTimeSeed
	.global	__aeabi_uidiv
	.align	2
	.global	I_GetTimeFrac
	.type	I_GetTimeFrac, %function
I_GetTimeFrac:
.LFB20:
	.loc 1 172 0
	.cfi_startproc
...
.L58:
	...
	.cfi_endproc
.LFE20:
	.size	I_GetTimeFrac, .-I_GetTimeFrac
	.global	__aeabi_ui2f
	.global	__aeabi_fmul
	.global	__aeabi_fadd
	.global	__aeabi_fdiv
	...
	.align	2
	.global	I_GetTime_SaveMS
	.type	I_GetTime_SaveMS, %function
I_GetTime_SaveMS:
.LFB21:
	.loc 1 192 0
	.cfi_startproc
...
.L67:
	...
	.cfi_endproc
.LFE21:
	.size	I_GetTime_SaveMS, .-I_GetTime_SaveMS
	.align	2
	.global	I_DoomExeDir
	.type	I_DoomExeDir, %function
I_DoomExeDir:
.LFB22:
	.loc 1 206 0
	.cfi_startproc
...
.LVL38:
	...
	ldreq	r3, .L73+4
	ldreq	r1, [r4, #16]
	ldreq	r0, [r3]	@ unaligned
	ldreqh	r2, [r3, #4]	@ unaligned
	ldreqb	r3, [r3, #6]	@ zero_extendqisi2
	streq	r0, [r1]	@ unaligned
	ldrne	r1, [r4, #16]
	streqh	r2, [r1, #4]	@ unaligned
	streqb	r3, [r1, #6]
	.loc 1 213 0
	ldr	r0, .L73+8
	bl	printf
...
.L73:
	...
	.cfi_endproc
.LFE22:
	.size	I_DoomExeDir, .-I_DoomExeDir
	.align	2
	.global	I_FindFile
	.type	I_FindFile, %function
I_FindFile:
.LFB13:
	.loc 1 72 0
	.cfi_startproc
...
.LVL48:
.L96:
	.loc 1 112 0 is_stmt 0 discriminator 17
	stmia	sp, {r0, r1, r8}
	mov	r2, r5
	ldr	r1, .L119+8
	mov	r0, r4
	bl	sprintf
.LVL49:
	.loc 1 116 0 is_stmt 1 discriminator 17
	mov	r0, r4
	mov	r1, #0
	bl	access
.LVL50:
...
.L128:
	.word	fastdemo
	.word	.LANCHOR1
	.word	I_GetTime_Scaled
	.word	I_GetTime_RealTime
	.word	I_GetTime_FastDemo
	.cfi_endproc
.LFE24:
	.size	I_Init, .-I_Init
	.align	2
	.global	I_SafeExit
	.type	I_SafeExit, %function
I_SafeExit:
.LFB25:
	.loc 1 271 0
	.cfi_startproc
...
.L131:
	...
	.cfi_endproc
.LFE25:
	.size	I_SafeExit, .-I_SafeExit
	.global	I_GetTime
	.comm	ms_to_next_tick,4,4
	.global	realtic_clock_rate
	.data
	.align	3
	.set	.LANCHOR1,. + 0
	.type	I_GetTime_Scale, %object
	.size	I_GetTime_Scale, 8
I_GetTime_Scale:
	.word	16777216
	.word	0
	.type	I_GetTime, %object
	.size	I_GetTime, 4
I_GetTime:
	.word	I_GetTime_Error
	.type	realtic_clock_rate, %object
	.size	realtic_clock_rate, 4
realtic_clock_rate:
	.word	100
	.section	.rodata.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"I_GetTime_Error: GetTime() used before initializati"
	.ascii	"on\000"
	.space	2
.LC1:
	.ascii	"I_Filelength: %s\000"
	.space	3
.LC3:
	.ascii	"base dir: %s\012\000"
	.space	2
.LC2:
	.ascii	"sdmc:/\000"
	.space	1
...
.LC6:
	...
	.space	2
.LC7:
	.ascii	"/usr/share/games/doom\000"
	.space	2
.LC8:
	.ascii	"/usr/local/share/games/doom\000"
.LC9:
	.ascii	"DOOMWADDIR\000"
	.space	1
.LC10:
	.ascii	"HOME\000"
	.space	3
.LC11:
	...
	.space	1
.LC12:
	.ascii	" found %s\012\000"
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
	.type	fasttic.9911, %object
	.size	fasttic.9911, 4
fasttic.9911:
	.space	4
	.type	InDisplay, %object
	.size	InDisplay, 4
InDisplay:
	.space	4
	.type	start_displaytime, %object
	.size	start_displaytime, 4
start_displaytime:
	.space	4
	.type	displaytime, %object
	.size	displaytime, 4
displaytime:
	.space	4
	.type	base.9937, %object
	.size	base.9937, 4
base.9937:
	.space	4
	.text
.Letext0:
	...
	.file 13 "c:/devl/prboom3ds/src/z_zone.h"
	.file 14 "c:/devl/prboom3ds/src/doomdef.h"
	.file 15 "c:/devl/prboom3ds/src/m_fixed.h"
	...
	.file 20 "c:/devl/prboom3ds/src/r_fps.h"
	.file 21 "c:/devl/prboom3ds/src/tables.h"
	.file 22 "c:/devkitPro/libctru/include/3ds/os.h"
	.file 23 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\errno.h"
	.file 24 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\string.h"
	.file 25 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h"
	.file 26 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\stdlib.h"
...
.LASF302:
	.ascii	"S_RBALLX3\000"
.LASF1489:
	.ascii	"c:/devl/prboom3ds/arm9/source/ds_sys.c\000"
.LASF404:
