...
S_PauseSound:
.LFB5:
	.file 1 "c:/devl/prboom3ds/arm11/source/3ds_sound.c"
	.loc 1 24 0
	.cfi_startproc
...
.LFE9:
	...
	.align	2
	.type	S_ChangeMusic.part.1, %function
S_ChangeMusic.part.1:
.LFB16:
	.loc 1 64 0
	.cfi_startproc
...
.LBE15:
	.cfi_endproc
.LFE16:
	.size	S_ChangeMusic.part.1, .-S_ChangeMusic.part.1
	.align	2
	.global	S_StartMusic
...
.LFE14:
	.size	S_Init, .-S_Init
	.comm	S_music_files,272,4
	.global	snd_samplerate
	.global	snd_MusicVolume
	.global	snd_SfxVolume
	.global	snd_MaxVolume
	.comm	default_numChannels,4,4
	.comm	idmusnum,4,4
	.global	mus_card
	.global	snd_card
	.section	.rodata
...
spmus.8095:
	...
	.align	2
	.set	.LANCHOR0,. + 0
	.type	snd_MaxVolume, %object
	.size	snd_MaxVolume, 4
snd_MaxVolume:
	.word	120
	.type	mus_card, %object
	.size	mus_card, 4
mus_card:
	.word	1
...
snd_MusicVolume:
	.word	15
	.type	snd_samplerate, %object
	.size	snd_samplerate, 4
snd_samplerate:
	.word	11025
...
snd_card:
	...
	.align	2
.LC0:
	.ascii	"S_ChangeMusic: Bad music number %d\000"
	.space	1
.LC1:
	.ascii	"d_%s\000"
	.space	3
.LC2:
	.ascii	"S_SetMusicVolume: Attempt to set music volume at %d"
	.ascii	"\000"
	.bss
	.align	2
	.set	.LANCHOR1,. + 0
	.type	mus_playing, %object
	.size	mus_playing, 4
mus_playing:
	.space	4
	.text
.Letext0:
	.file 2 "c:/devl/prboom3ds/src/sounds.h"
	...
	.file 15 "c:/devl/prboom3ds/src/d_main.h"
	.file 16 "c:/devl/prboom3ds/src/w_wad.h"
...
.LASF205:
	.ascii	"SPR_YSKU\000"
.LASF1672:
	.ascii	"c:/devl/prboom3ds/arm11/source/3ds_sound.c\000"
.LASF570:
	.ascii	"S_FIRE10\000"
.LASF571:
	.ascii	"S_FIRE11\000"
