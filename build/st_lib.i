# 1 "c:/devl/prboom3ds/src/st_lib.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/st_lib.c"
# 34 "c:/devl/prboom3ds/src/st_lib.c"
...
# 35 "c:/devl/prboom3ds/src/st_lib.c" 2
...
# 36 "c:/devl/prboom3ds/src/st_lib.c" 2
...
void V_FreeScreens();
# 37 "c:/devl/prboom3ds/src/st_lib.c" 2
...
# 38 "c:/devl/prboom3ds/src/st_lib.c" 2
...
# 39 "c:/devl/prboom3ds/src/st_lib.c" 2
# 1 "c:/devl/prboom3ds/src/st_lib.h" 1
# 53 "c:/devl/prboom3ds/src/st_lib.h"
typedef struct
{
...
# 146 "c:/devl/prboom3ds/src/st_lib.h"
...
( st_binicon_t* bi,
  boolean refresh );
# 40 "c:/devl/prboom3ds/src/st_lib.c" 2
...
# 41 "c:/devl/prboom3ds/src/st_lib.c" 2
...
# 42 "c:/devl/prboom3ds/src/st_lib.c" 2
...
# 63 "c:/devl/prboom3ds/src/st_lib.c"
void STlib_initNum
( st_number_t* n,
  int x,
  int y,
...
# 94 "c:/devl/prboom3ds/src/st_lib.c"
  ...
  boolean refresh )
{
  ...
  V_CopyRect(x, n->y - (200 - 32), 4, w*numdigits, h, x, n->y, 0, VPT_STRETCH);
  ...
  if (!num)
    ...
    V_DrawNumPatch(x - w, n->y, 0, n->p[0].lumpnum, cm,
       (((cm!=CR_RED) && !sts_always_red) ? VPT_TRANS : VPT_NONE) | VPT_STRETCH);
  ...
  while (num && numdigits--) {
    ...
    x -= w;
    V_DrawNumPatch(x, n->y, 0, n->p[num % 10].lumpnum, cm,
       (((cm!=CR_RED) && !sts_always_red) ? VPT_TRANS : VPT_NONE) | VPT_STRETCH);
    num /= 10;
  }
  ...
  if (neg)
    V_DrawNumPatch(x - w,n->y,0,W_GetNumForName("STTMINUS"),cm,(((cm!=CR_RED) && !sts_always_red) ? VPT_TRANS : VPT_NONE) | VPT_STRETCH)
                                                                                    ;
}
# 180 "c:/devl/prboom3ds/src/st_lib.c"
void STlib_updateNum
( st_number_t* n,
  int cm,
  boolean refresh )
...
# 198 "c:/devl/prboom3ds/src/st_lib.c"
void STlib_initPercent
( st_percent_t* p,
  int x,
  int y,
...
# 223 "c:/devl/prboom3ds/src/st_lib.c"
void STlib_updatePercent
( st_percent_t* per,
  int cm,
  int refresh )
{
  if (*per->n.on && (refresh || (per->n.oldnum != *per->n.num))) {
    ...
    V_DrawNumPatch(per->n.x, per->n.y, 0, per->p->lumpnum,
...
# 250 "c:/devl/prboom3ds/src/st_lib.c"
void STlib_initMultIcon
( st_multicon_t* i,
  int x,
  int y,
...
# 276 "c:/devl/prboom3ds/src/st_lib.c"
void STlib_updateMultIcon
( st_multicon_t* mi,
  boolean refresh )
{
  ...
  if (*mi->on && (mi->oldinum != *mi->inum || refresh))
  {
    if (mi->oldinum != -1)
    {
      ...
      V_CopyRect(x, y-(200 - 32), 4, w, h, x, y, 0, VPT_STRETCH);
    }
    if (*mi->inum != -1)
      V_DrawNumPatch(mi->x, mi->y, 0, mi->p[*mi->inum].lumpnum, CR_RED, VPT_STRETCH);
    mi->oldinum = *mi->inum;
  }
}
# 317 "c:/devl/prboom3ds/src/st_lib.c"
void STlib_initBinIcon
( st_binicon_t* b,
  int x,
  int y,
...
# 346 "c:/devl/prboom3ds/src/st_lib.c"
void STlib_updateBinIcon
( st_binicon_t* bi,
  boolean refresh )
{
  ...
  if (*bi->on && (bi->oldval != *bi->val || refresh))
  {
    ...
    if (*bi->val)
      V_DrawNumPatch(bi->x, bi->y, 0, bi->p->lumpnum, CR_RED, VPT_STRETCH);
    else
      V_CopyRect(x, y-(200 - 32), 4, w, h, x, y, 0, VPT_STRETCH);
