# 1 "c:/devl/prboom3ds/src/p_doors.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_doors.c"
# 34 "c:/devl/prboom3ds/src/p_doors.c"
...
# 35 "c:/devl/prboom3ds/src/p_doors.c" 2
...
# 36 "c:/devl/prboom3ds/src/p_doors.c" 2
...
# 37 "c:/devl/prboom3ds/src/p_doors.c" 2
...
extern int idmusnum;
# 38 "c:/devl/prboom3ds/src/p_doors.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_doors.c" 2
...
# 40 "c:/devl/prboom3ds/src/p_doors.c" 2
...
# 41 "c:/devl/prboom3ds/src/p_doors.c" 2
...
# 42 "c:/devl/prboom3ds/src/p_doors.c" 2
...
# 43 "c:/devl/prboom3ds/src/p_doors.c" 2
# 60 "c:/devl/prboom3ds/src/p_doors.c"
  ...
  switch(door->direction)
  {
    ...
    case 1:
      ...
      if (res == pastdest)
      {
        ...
        if (door->lighttag && door->topheight - door->sector->floorheight && compatibility_level < mbf_compatibility)
          EV_LightTurnOnPartway(door->line,(1<<16));
      }
      break;
  }
}
# 294 "c:/devl/prboom3ds/src/p_doors.c"
int EV_DoLockedDoor
( line_t* line,
  vldoor_e type,
  mobj_t* thing )
...
# 353 "c:/devl/prboom3ds/src/p_doors.c"
int EV_DoDoor
( line_t* line,
  vldoor_e type )
{
...
# 448 "c:/devl/prboom3ds/src/p_doors.c"
int EV_VerticalDoor
( line_t* line,
  mobj_t* thing )
{
  ...
  if (line->sidenum[1]==((unsigned short)-1))
  {
    S_StartSound(player->mo,sfx_oof);
    return 0;
  }
  ...
  secnum = sec-sectors;
# 521 "c:/devl/prboom3ds/src/p_doors.c"
...
# 656 "c:/devl/prboom3ds/src/p_doors.c"
...
# 686 "c:/devl/prboom3ds/src/p_doors.c"
void P_SpawnDoorRaiseIn5Mins
( sector_t* sec,
  int secnum )
{
