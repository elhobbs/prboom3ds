# 1 "c:/devl/prboom3ds/src/p_lights.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_lights.c"
# 36 "c:/devl/prboom3ds/src/p_lights.c"
...
# 37 "c:/devl/prboom3ds/src/p_lights.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_lights.c" 2
...
# 40 "c:/devl/prboom3ds/src/p_lights.c" 2
...
# 41 "c:/devl/prboom3ds/src/p_lights.c" 2
...
# 42 "c:/devl/prboom3ds/src/p_lights.c" 2
# 57 "c:/devl/prboom3ds/src/p_lights.c"
...
# 82 "c:/devl/prboom3ds/src/p_lights.c"
...
# 108 "c:/devl/prboom3ds/src/p_lights.c"
...
# 134 "c:/devl/prboom3ds/src/p_lights.c"
...
# 177 "c:/devl/prboom3ds/src/p_lights.c"
...
# 205 "c:/devl/prboom3ds/src/p_lights.c"
...
# 237 "c:/devl/prboom3ds/src/p_lights.c"
void P_SpawnStrobeFlash
( sector_t* sector,
  int fastOrSlow,
  int inSync )
...
# 276 "c:/devl/prboom3ds/src/p_lights.c"
...
# 310 "c:/devl/prboom3ds/src/p_lights.c"
...
# 339 "c:/devl/prboom3ds/src/p_lights.c"
...
# 371 "c:/devl/prboom3ds/src/p_lights.c"
...
# 414 "c:/devl/prboom3ds/src/p_lights.c"
int EV_LightTurnOnPartway(line_t *line, fixed_t level)
{
  int i;
  ...
  if ((temp = getNextSector(sector->lines[j],sector)))
    {
      ...
      sector->lightlevel =
  (level * bright + ((1<<16)-level) * min) >> 16;
    }
  return 1;
}
