# 1 "c:/devl/prboom3ds/src/r_bsp.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/r_bsp.c"
# 34 "c:/devl/prboom3ds/src/r_bsp.c"
...
# 35 "c:/devl/prboom3ds/src/r_bsp.c" 2
...
# 36 "c:/devl/prboom3ds/src/r_bsp.c" 2
...
# 39 "c:/devl/prboom3ds/src/r_bsp.c" 2
...
# 40 "c:/devl/prboom3ds/src/r_bsp.c" 2
...
# 41 "c:/devl/prboom3ds/src/r_bsp.c" 2
...
void V_FreeScreens();
# 42 "c:/devl/prboom3ds/src/r_bsp.c" 2
...
# 43 "c:/devl/prboom3ds/src/r_bsp.c" 2
...
static void R_ClipWallSegment(int first, int last, boolean solid)
{
  ...
  while (first < last) {
    if (solidcol[first]) {
      if (!(p = memchr(solidcol+first, 0, last-first))) return;
      first = p - solidcol;
    } else {
      int to;
...
# 199 "c:/devl/prboom3ds/src/r_bsp.c"
...
# 380 "c:/devl/prboom3ds/src/r_bsp.c"
  if (x1 >= x2)
    return;
  ...
  if (backsector)
    ...
    backsector = R_FakeFlat(backsector, &tempsec, ((void *)0), ((void *)0), 1);
...
# 410 "c:/devl/prboom3ds/src/r_bsp.c"
...
static boolean R_CheckBBox(const fixed_t *bspcoord)
{
  ...
  if ((signed)angle1 < (signed)angle2) {
    ...
    if ((angle1 >= 0x80000000) && (angle1 < 0xc0000000))
      angle1 = 2147483647;
    else
      angle2 = (-2147483647 - 1);
  }

  if ((signed)angle2 >= (signed)clipangle) return 0;
  if ((signed)angle1 <= -(signed)clipangle) return 0;
  ...
  angle2 = (angle2+0x40000000)>>19;
  {
    ...
    if (!memchr(solidcol+sx1, 0, sx2-sx1)) return 0;

  }

  return 1;
}
# 493 "c:/devl/prboom3ds/src/r_bsp.c"
...
# 511 "c:/devl/prboom3ds/src/r_bsp.c"
  sub = &subsectors[num];
  ...
  floorplane = frontsector->floorheight < viewz ||
    ...
    R_FindPlane(frontsector->floorheight,
                ...
                frontsector->sky & (0x80000000) ? frontsector->sky :
...
# 623 "c:/devl/prboom3ds/src/r_bsp.c"
...
# 645 "c:/devl/prboom3ds/src/r_bsp.c"
void R_RenderBSPNode(int bspnum)
{
  while (!(bspnum & 0x80000000))
    {
  ...
  R_Subsector(bspnum == -1 ? 0 : bspnum & ~0x80000000);
}
