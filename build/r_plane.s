...
.Ltext0:
	...
	.align	2
	.type	new_visplane, %function
new_visplane:
.LFB8:
	.file 1 "c:/devl/prboom3ds/src/r_plane.c"
	.loc 1 220 0
	.cfi_startproc
...
.L7:
	...
	.cfi_endproc
.LFE8:
	.size	new_visplane, .-new_visplane
	.align	2
...
.LFE14:
	...
	.comm	distscale,1600,4
	.comm	yslope,960,4
	.comm	ceilingclip,1600,4
	.comm	floorclip,1600,4
	.comm	lastopening,4,4
	.comm	openings,4,4
	.comm	maxopenings,4,4
	.comm	ceilingplane,4,4
	.comm	floorplane,4,4
	.data
	.align	2
	.set	.LANCHOR1,. + 0
	.type	freehead, %object
	.size	freehead, 4
freehead:
	.word	freetail
	.bss
...
planeheight:
	...
	.size	cachedheight, 960
cachedheight:
	.space	960
	.type	cacheddistance, %object
	.size	cacheddistance, 960
cacheddistance:
	.space	960
...
.LASF1817:
	.ascii	"c:/devl/prboom3ds/src/r_plane.c\000"
.LASF1259:
