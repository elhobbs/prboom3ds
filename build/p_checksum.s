...
.Ltext0:
	...
	.align	2
	.type	p_checksum_nop, %function
p_checksum_nop:
.LFB4:
	.file 1 "c:/devl/prboom3ds/src/p_checksum.c"
	.loc 1 16 0
	.cfi_startproc
...
.LVL0:
	...
	.cfi_endproc
.LFE4:
	.size	p_checksum_nop, .-p_checksum_nop
	.align	2
	.type	p_checksum_cleanup, %function
p_checksum_cleanup:
.LFB7:
	.loc 1 63 0
	.cfi_startproc
...
.L8:
	...
	.cfi_endproc
.LFE7:
	.size	p_checksum_cleanup, .-p_checksum_cleanup
	.align	2
	.global	checksum_gamestate
	.type	checksum_gamestate, %function
checksum_gamestate:
.LFB8:
	.loc 1 71 0
	.cfi_startproc
...
.L21:
	...
	.cfi_endproc
.LFE8:
	.size	checksum_gamestate, .-checksum_gamestate
	.align	2
	.global	P_RecordChecksum
	.type	P_RecordChecksum, %function
P_RecordChecksum:
.LFB5:
	.loc 1 26 0
	.cfi_startproc
...
.L29:
	...
	.word	.LANCHOR0+4
	.word	.LANCHOR1
	.word	checksum_gamestate
	.word	.LC4
	.word	p_checksum_cleanup
	.word	.LC5
	.cfi_endproc
.LFE5:
	.size	P_RecordChecksum, .-P_RecordChecksum
	.align	2
	.global	P_ChecksumFinal
	.type	P_ChecksumFinal, %function
P_ChecksumFinal:
.LFB6:
	.loc 1 48 0
	.cfi_startproc
...
.L40:
	...
	.cfi_endproc
.LFE6:
	.size	P_ChecksumFinal, .-P_ChecksumFinal
	.global	P_Checksum
	.data
	.align	2
	.set	.LANCHOR1,. + 0
	.type	P_Checksum, %object
	.size	P_Checksum, 4
P_Checksum:
	.word	p_checksum_nop
...
.LC4:
	...
	.space	1
.LC5:
	.ascii	"cannot open %s for writing checksum:\012%s\012\000"
	.space	3
.LC6:
	.ascii	"final: \000"
	.bss
...
.Letext0:
	...
	.file 8 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\stdint.h"
	.file 9 "c:/devl/prboom3ds/src/md5.h"
...
.LASF1218:
	.ascii	"S_MEAT5\000"
.LASF1686:
	.ascii	"c:/devl/prboom3ds/src/p_checksum.c\000"
.LASF330:
