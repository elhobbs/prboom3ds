# 1 "c:/devl/prboom3ds/src/z_zone.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/z_zone.c"
# 49 "c:/devl/prboom3ds/src/z_zone.c"
...
# 50 "c:/devl/prboom3ds/src/z_zone.c" 2
...
# 51 "c:/devl/prboom3ds/src/z_zone.c" 2
...
# 53 "c:/devl/prboom3ds/src/z_zone.c" 2
...
# 54 "c:/devl/prboom3ds/src/z_zone.c" 2
...
# 55 "c:/devl/prboom3ds/src/z_zone.c" 2
...
void V_FreeScreens();
# 56 "c:/devl/prboom3ds/src/z_zone.c" 2
...
# 57 "c:/devl/prboom3ds/src/z_zone.c" 2
...
# 58 "c:/devl/prboom3ds/src/z_zone.c" 2
# 88 "c:/devl/prboom3ds/src/z_zone.c"
...
static const size_t HEADER_SIZE = (sizeof(memblock_t)+32 -1) & ~(32 -1);
...
# 262 "c:/devl/prboom3ds/src/z_zone.c"
...
void Z_Init(void)
{
# 325 "c:/devl/prboom3ds/src/z_zone.c"
}
# 339 "c:/devl/prboom3ds/src/z_zone.c"
...
{
  memblock_t *block = ((void *)0);
# 366 "c:/devl/prboom3ds/src/z_zone.c"
  if (!size)
    return user ? *user = ((void *)0) : ((void *)0);
...
# 443 "c:/devl/prboom3ds/src/z_zone.c"
  block->tag = tag;
  block->user = user;
...
# 475 "c:/devl/prboom3ds/src/z_zone.c"
  if (!p)
    return;
# 491 "c:/devl/prboom3ds/src/z_zone.c"
  if (block->user)
    *block->user = ((void *)0);

  if (block == block->next)
    blockbytag[block->tag] = ((void *)0);
  else
  ...
  free_memory += block->size;
# 516 "c:/devl/prboom3ds/src/z_zone.c"
  (free)(block);
       ...
       )
{
  ...
  if (tag == block->tag)
    return;
# 604 "c:/devl/prboom3ds/src/z_zone.c"
  if (block == block->next)
    blockbytag[block->tag] = ((void *)0);
  else
    if (blockbytag[block->tag] == block)
...
# 639 "c:/devl/prboom3ds/src/z_zone.c"
  block->tag = tag;
}
...
{
  return
    (n1*=n2) ? memset((Z_Malloc)(n1, tag, user ), 0, n1) : ((void *)0);
}
...
{
# 710 "c:/devl/prboom3ds/src/z_zone.c"
}
