# 1 "c:/devl/prboom3ds/src/r_patch.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/r_patch.c"
# 31 "c:/devl/prboom3ds/src/r_patch.c"
...
# 32 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 54 "c:/devl/prboom3ds/src/doomdef.h"
...
# 33 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 34 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 35 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 36 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 37 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 38 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 39 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 40 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 42 "c:/devl/prboom3ds/src/r_patch.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 44 "c:/devl/prboom3ds/src/r_patch.c" 2
...
# 63 "c:/devl/prboom3ds/src/r_patch.c"
typedef struct
{
  short width, height;
  short leftoffset;
...
static int getPatchIsNotTileable(const patch_t *patch) {
  ...
  for (x=0; x<(short int)(patch->width); x++) {
    column = (const column_t *)((const byte *)patch + (long int)(patch->columnofs[x]));
    ...
    while (column->topdelta != 0xff) {
      ...
      else if (x == 0 && column->topdelta + column->length >= (short int)(patch->height)) cornerCount++;
      else if (x == (short int)(patch->width)-1 && column->topdelta == 0) cornerCount++;
      else if (x == (short int)(patch->width)-1 && column->topdelta + column->length >= (short int)(patch->height)) cornerCount++;
...
static void createPatch(int id) {
  ...
  patch->width = (short int)(oldPatch->width);
  patch->widthmask = 0;
  patch->height = (short int)(oldPatch->height);
  patch->leftoffset = (short int)(oldPatch->leftoffset);
  patch->topoffset = (short int)(oldPatch->topoffset);
  ...
  for (x=0; x<patch->width; x++) {
    oldColumn = (const column_t *)((const byte *)oldPatch + (long int)(oldPatch->columnofs[x]));
  ...
  (((((byte*)patch->posts + numPostsTotal*sizeof(rpost_t)) - (byte*)patch->data) == dataSize) ? (void)0 : __assert_func ("c:/devl/prboom3ds/src/r_patch.c", 249, __FUNCTION__, "(((byte*)patch->posts + numPostsTotal*sizeof(rpost_t)) - (byte*)patch->data) == dataSize"));
  ...
  for (x=0; x<patch->width; x++) {
    ...
    if (patch->isNotTileable) {
      ...
      else oldPrevColumn = (const column_t *)((const byte *)oldPatch + (long int)(oldPatch->columnofs[x-1]));
      if (x == patch->width-1) oldNextColumn = 0;
      else oldNextColumn = (const column_t *)((const byte *)oldPatch + (long int)(oldPatch->columnofs[x+1]));
    }
    else {
      ...
      oldPrevColumn = (const column_t *)((const byte *)oldPatch + (long int)(oldPatch->columnofs[prevColumnIndex]));
      oldNextColumn = (const column_t *)((const byte *)oldPatch + (long int)(oldPatch->columnofs[nextColumnIndex]));
    }
...
static void createTextureCompositePatch(int id) {
  ...
  for (i=0; i<texture->patchcount; i++) {
    ...
    for (x=0; x<(short int)(oldPatch->width); x++) {
  ...
  (((((byte*)composite_patch->posts + numPostsTotal*sizeof(rpost_t)) - (byte*)composite_patch->data) == dataSize) ? (void)0 : __assert_func ("c:/devl/prboom3ds/src/r_patch.c", 486, __FUNCTION__, "(((byte*)composite_patch->posts + numPostsTotal*sizeof(rpost_t)) - (byte*)composite_patch->data) == dataSize"));
  ...
  for (i=0; i<texture->patchcount; i++) {
    ...
    for (x=0; x<(short int)(oldPatch->width); x++) {
...

      {
        ...
        int prevColumnIndex = x-1;
        int nextColumnIndex = x+1;
        while (prevColumnIndex < 0) prevColumnIndex += (short int)(oldPatch->width);
        while (nextColumnIndex >= (short int)(oldPatch->width)) nextColumnIndex -= (short int)(oldPatch->width);
        oldPrevColumn = (const column_t *)((const byte *)oldPatch + (long int)(oldPatch->columnofs[prevColumnIndex]));
        oldNextColumn = (const column_t *)((const byte *)oldPatch + (long int)(oldPatch->columnofs[nextColumnIndex]));
      }
      ...
      while (oldColumn->topdelta != 0xff) {
        ...
        ((countsInColumn[tx].posts_used <= countsInColumn[tx].posts) ? (void)0 : __assert_func ("c:/devl/prboom3ds/src/r_patch.c", 606, __FUNCTION__, "countsInColumn[tx].posts_used <= countsInColumn[tx].posts"));
      }
    }
