...
.Ltext0:
	...
	.align	2
	.global	T_StrobeFlash
	.type	T_StrobeFlash, %function
T_StrobeFlash:
.LFB6:
	.file 1 "c:/devl/prboom3ds/src/p_lights.c"
	.loc 1 109 0
	.cfi_startproc
...
.LBB5:
	...
	ldreq	r1, [r0, #36]
	.loc 1 120 0
	strneh	r2, [r3, #188]	@ movhi
	.loc 1 115 0
	streqh	r1, [r3, #188]	@ movhi
	.loc 1 121 0
	strne	r1, [r0, #28]
	.loc 1 116 0
	streq	r2, [r0, #28]
...
.LVL2:
	...
	cmp	lr, ip
	.loc 1 150 0
	strh	r3, [r2, #188]	@ movhi
	.loc 1 154 0
	mvnge	r3, #0
	.loc 1 153 0
	strgeh	r1, [r2, #188]	@ movhi
	.loc 1 154 0
	strge	r3, [r0, #36]
	ldr	pc, [sp], #4
.L7:
...
.LFE14:
	...
	.align	2
	.global	EV_LightTurnOnPartway
	.type	EV_LightTurnOnPartway, %function
...
.LBE27:
	.cfi_endproc
.LFE15:
	.size	EV_LightTurnOnPartway, .-EV_LightTurnOnPartway
.Letext0:
...
.LASF1718:
	.ascii	"c:/devl/prboom3ds/src/p_lights.c\000"
.LASF1273:
	.ascii	"MT_PUFF\000"
.LASF1519:
