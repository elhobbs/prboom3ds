# 1 "c:/devl/prboom3ds/src/r_data.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/r_data.c"
# 35 "c:/devl/prboom3ds/src/r_data.c"
...
# 36 "c:/devl/prboom3ds/src/r_data.c" 2
...
# 37 "c:/devl/prboom3ds/src/r_data.c" 2
# 1 "c:/devl/prboom3ds/src/r_draw.h" 1
# 37 "c:/devl/prboom3ds/src/r_draw.h"
...
# 38 "c:/devl/prboom3ds/src/r_draw.h" 2
...
# 38 "c:/devl/prboom3ds/src/r_data.c" 2
...
# 39 "c:/devl/prboom3ds/src/r_data.c" 2
...
# 40 "c:/devl/prboom3ds/src/r_data.c" 2
...
# 41 "c:/devl/prboom3ds/src/r_data.c" 2
...
# 42 "c:/devl/prboom3ds/src/r_data.c" 2
# 1 "c:/devl/prboom3ds/src/r_things.h" 1
# 45 "c:/devl/prboom3ds/src/r_things.h"
...
# 43 "c:/devl/prboom3ds/src/r_data.c" 2
...
# 44 "c:/devl/prboom3ds/src/r_data.c" 2
...
# 45 "c:/devl/prboom3ds/src/r_data.c" 2
# 64 "c:/devl/prboom3ds/src/r_data.c"
typedef struct
{
  short originx;
  short originy;
...
static void R_InitTextures (void)
{
  ...
  nummappatches = (long int)(*((const int *)names));
  name_p = names+4;
  ...
  for (i=0 ; i<nummappatches ; i++)
    {
      ...
      if (patchlookup[i] == -1)
        {
# 161 "c:/devl/prboom3ds/src/r_data.c"
  ...
  for (i=0 ; i<numtextures ; i++, directory++)
    {
      ...
      texture = textures[i] =
        Z_Malloc(sizeof(texture_t) +
                 sizeof(texpatch_t)*((short int)(mtexture->patchcount)-1),
                 PU_STATIC, 0);

      texture->width = (short int)(mtexture->width);
      texture->height = (short int)(mtexture->height);
      texture->patchcount = (short int)(mtexture->patchcount);
# 257 "c:/devl/prboom3ds/src/r_data.c"
      {
        int j;
      ...
      for (j=0 ; j<texture->patchcount ; j++, mpatch++, patch++)
        {
          patch->originx = (short int)(mpatch->originx);
          patch->originy = (short int)(mpatch->originy);
          patch->patch = patchlookup[(short int)(mpatch->patch)];
          if (patch->patch == -1)
            {

              lprintf(LO_ERROR,"\nR_InitTextures: Missing patch %d in texture %.8s",
                     (short int)(mpatch->patch), texture->name);
              ++errors;
            }
        }
...
# 378 "c:/devl/prboom3ds/src/r_data.c"
static void R_InitColormaps(void)
{
  ...
  colormaps[0] = (const lighttable_t *)W_CacheLumpNum (W_GetNumForName("COLORMAP"));
...
# 411 "c:/devl/prboom3ds/src/r_data.c"
...
const lighttable_t* R_ColourMap(int lightlevel, fixed_t spryscale)
{
  if (fixedcolormap) return fixedcolormap;
    ...
    lightlevel += extralight << 4;
# 439 "c:/devl/prboom3ds/src/r_data.c"
    return fullcolormap + between(0,32 -1,
          ((256-lightlevel)*2*32/256) - 4
          - (FixedMul(spryscale,pspriteiscale)/2 >> 12)
          )*256;
  }
}
# 454 "c:/devl/prboom3ds/src/r_data.c"
...
{
  int lump = (W_CheckNumForName)("TRANMAP", ns_global);



  if (lump != -1)
    main_tranmap = W_CacheLumpNum(lump);
  else if ((W_CheckNumForName)("PLAYPAL", ns_global)!=-1)
    {
      const byte *playpal = W_CacheLumpNum (W_GetNumForName("PLAYPAL"));
      byte *my_tranmap;
      ...
      fnlen = doom_snprintf(((void *)0), 0, "%s/tranmap.dat", I_DoomExeDir());
      fname = Z_Malloc(fnlen+1,PU_STATIC,0);
      ...
      if (!cachefp ||
          ...
          fread(my_tranmap, 256, 256, cachefp) != 256 )
        {
          ...
          if ((cachefp = fopen(fname,"wb")) != ((void *)0))
            {
              cache.pct = tran_filter_pct;
...
# 578 "c:/devl/prboom3ds/src/r_data.c"
void R_InitData(void)
{
...
# 602 "c:/devl/prboom3ds/src/r_data.c"
int R_FlatNumForName(const char *name)
{
...
# 622 "c:/devl/prboom3ds/src/r_data.c"
int __attribute__((pure)) R_CheckTextureNumForName(const char *name)
{
  int i = 0;
  if (*name != '-')
...
# 669 "c:/devl/prboom3ds/src/r_data.c"
...
# 714 "c:/devl/prboom3ds/src/r_data.c"
  ...
  {
    thinker_t *th = ((void *)0);
    while ((th = P_NextThinker(th,th_all)) != ((void *)0))
...
void R_SetPatchNum(patchnum_t *patchnum, const char *name)
{
  const rpatch_t *patch = R_CachePatchNum(W_GetNumForName(name));
  ...
  R_UnlockPatchNum(W_GetNumForName(name));
}
