# 1 "c:/devl/prboom3ds/src/p_telept.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_telept.c"
# 34 "c:/devl/prboom3ds/src/p_telept.c"
...
# 35 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 36 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 37 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 38 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 40 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 41 "c:/devl/prboom3ds/src/p_telept.c" 2
...
extern int idmusnum;
# 42 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 43 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 44 "c:/devl/prboom3ds/src/p_telept.c" 2
...
# 45 "c:/devl/prboom3ds/src/p_telept.c" 2

static mobj_t* P_TeleportDestination(line_t* line)
{
  int i;
  for (i = -1; (i = P_FindSectorFromLineTag(line, i)) >= 0;) {
    register thinker_t* th = ((void *)0);
    while ((th = P_NextThinker(th,th_misc)) != ((void *)0))
...
int EV_Teleport(line_t *line, int side, mobj_t *thing)
{
  ...
  if (side || thing->flags & (uint_64_t)(0x0000000000010000))
    return 0;




  if ((m = P_TeleportDestination(line)) != ((void *)0))
        {
          ...
          S_StartSound(P_SpawnMobj(m->x +
                                    20*finecosine[m->angle>>19],
                                   m->y +
                                    20*finesine[m->angle>>19],
                                   thing->z, MT_TFOG),
                       sfx_telept);
  ...
  if ((m = P_TeleportDestination(line)) != ((void *)0))
        {
          ...
          angle_t angle =
            R_PointToAngle2(0, 0, line->dx, line->dy) - m->angle + 0x40000000;


          fixed_t s = finesine[angle>>19];
          fixed_t c = finecosine[angle>>19];
...
# 219 "c:/devl/prboom3ds/src/p_telept.c"
    ...
    if ((l=lines+i) != line && l->backsector)
      {
        ...
        angle_t angle = (reverse ? pos = (1<<16)-pos, 0 : 0x80000000) +
        ...
        fixed_t z = thing->z - thing->floorz;
# 289 "c:/devl/prboom3ds/src/p_telept.c"
