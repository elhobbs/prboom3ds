# 1 "c:/devl/prboom3ds/src/p_switch.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_switch.c"
# 34 "c:/devl/prboom3ds/src/p_switch.c"
...
# 35 "c:/devl/prboom3ds/src/p_switch.c" 2
...
# 36 "c:/devl/prboom3ds/src/p_switch.c" 2
...
# 37 "c:/devl/prboom3ds/src/p_switch.c" 2
...
# 38 "c:/devl/prboom3ds/src/p_switch.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_switch.c" 2
...
extern int idmusnum;
# 40 "c:/devl/prboom3ds/src/p_switch.c" 2
...
# 41 "c:/devl/prboom3ds/src/p_switch.c" 2
...
# 42 "c:/devl/prboom3ds/src/p_switch.c" 2
...
button_t buttonlist[(4*4)];
# 70 "c:/devl/prboom3ds/src/p_switch.c"
void P_InitSwitchList(void)
{
  ...
  for (i=0;;i++)
  {
    if (index+1 >= max_numswitches)
      switchlist = Z_Realloc(switchlist,sizeof *switchlist * (max_numswitches = max_numswitches ? max_numswitches*2 : 8),PU_STATIC,0)
                                                                      ;
    if ((short int)(alphSwitchList[i].episode) <= episode)
    {
      int texture1, texture2;

      if (!(short int)(alphSwitchList[i].episode))
        break;
...
# 125 "c:/devl/prboom3ds/src/p_switch.c"
...
# 164 "c:/devl/prboom3ds/src/p_switch.c"
void P_ChangeSwitchTexture
( line_t* line,
  int useAgain )
{
  ...
  *texture = switchlist[i^1];
  ...
  if (useAgain)
    P_StartButton(line, position, switchlist[i], 35);
}
# 231 "c:/devl/prboom3ds/src/p_switch.c"
boolean
P_UseSpecialLine
( mobj_t* thing,
  line_t* line,
