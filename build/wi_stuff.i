# 1 "c:/devl/prboom3ds/src/wi_stuff.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/wi_stuff.c"
# 35 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 36 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
# 37 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
# 38 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
# 39 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
# 40 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
void V_FreeScreens();
# 41 "c:/devl/prboom3ds/src/wi_stuff.c" 2
# 1 "c:/devl/prboom3ds/src/wi_stuff.h" 1
# 43 "c:/devl/prboom3ds/src/wi_stuff.h"
typedef enum
{
  NoState = -1,
  StatCount,
...
void WI_End(void);
# 42 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
extern int idmusnum;
# 43 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
# 44 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
# 45 "c:/devl/prboom3ds/src/wi_stuff.c" 2
...
# 46 "c:/devl/prboom3ds/src/wi_stuff.c" 2


extern boolean deh_pars;
# 115 "c:/devl/prboom3ds/src/wi_stuff.c"
typedef enum
{
  ANIM_ALWAYS,
  ANIM_RANDOM,
...
{
  { ANIM_ALWAYS, 35/3, 3, { 224, 104 } },
  { ANIM_ALWAYS, 35/3, 3, { 184, 160 } },
  { ANIM_ALWAYS, 35/3, 3, { 112, 136 } },
  { ANIM_ALWAYS, 35/3, 3, { 72, 112 } },
  { ANIM_ALWAYS, 35/3, 3, { 88, 96 } },
  { ANIM_ALWAYS, 35/3, 3, { 64, 48 } },
  { ANIM_ALWAYS, 35/3, 3, { 192, 40 } },
  { ANIM_ALWAYS, 35/3, 3, { 136, 16 } },
  { ANIM_ALWAYS, 35/3, 3, { 80, 16 } },
  { ANIM_ALWAYS, 35/3, 3, { 64, 24 } }
};

static anim_t epsd1animinfo[] =
{
  { ANIM_LEVEL, 35/3, 1, { 128, 136 }, 1 },
  { ANIM_LEVEL, 35/3, 1, { 128, 136 }, 2 },
  { ANIM_LEVEL, 35/3, 1, { 128, 136 }, 3 },
  { ANIM_LEVEL, 35/3, 1, { 128, 136 }, 4 },
  { ANIM_LEVEL, 35/3, 1, { 128, 136 }, 5 },
  { ANIM_LEVEL, 35/3, 1, { 128, 136 }, 6 },
  { ANIM_LEVEL, 35/3, 1, { 128, 136 }, 7 },
  { ANIM_LEVEL, 35/3, 3, { 192, 144 }, 8 },
  { ANIM_LEVEL, 35/3, 1, { 128, 136 }, 8 }
};

static anim_t epsd2animinfo[] =
{
  { ANIM_ALWAYS, 35/3, 3, { 104, 168 } },
  { ANIM_ALWAYS, 35/3, 3, { 40, 136 } },
  { ANIM_ALWAYS, 35/3, 3, { 160, 96 } },
  { ANIM_ALWAYS, 35/3, 3, { 104, 80 } },
  { ANIM_ALWAYS, 35/3, 3, { 120, 32 } },
  { ANIM_ALWAYS, 35/4, 3, { 40, 0 } }
};
...
static anim_t *anims[4] =
{
  epsd0animinfo,
  epsd1animinfo,
  epsd2animinfo
};
# 303 "c:/devl/prboom3ds/src/wi_stuff.c"
int acceleratestage;
...
# 397 "c:/devl/prboom3ds/src/wi_stuff.c"
...
static void WI_slamBackground(void)
{
  ...
  V_DrawNumPatch(0,0,0,W_GetNumForName(name),CR_RED,VPT_STRETCH);
}
# 434 "c:/devl/prboom3ds/src/wi_stuff.c"
boolean WI_Responder(event_t* ev)
{
  return 0;
}
# 446 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_drawLF(void)
{
  int y = 2;
  char lname[9];
  ...
  if ((W_CheckNumForName)(lname, ns_global) >= 0)
  {

    V_DrawNumPatch((320 - R_NumPatchWidth(W_GetNumForName(lname)))/2,y,0,W_GetNumForName(lname),CR_RED,VPT_STRETCH)
                                          ;


    y += (5*R_NumPatchHeight(W_GetNumForName(lname)))/4;
  }


  V_DrawNumPatch((320 - R_NumPatchWidth(W_GetNumForName(finished)))/2,y,0,W_GetNumForName(finished),CR_RED,VPT_STRETCH)
                                           ;
}
# 477 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_drawEL(void)
{
  int y = 2;
  char lname[9];
  ...
  V_DrawNumPatch((320 - R_NumPatchWidth(W_GetNumForName(entering)))/2,y,0,W_GetNumForName(entering),CR_RED,VPT_STRETCH)
                                               ;
...
# 509 "c:/devl/prboom3ds/src/wi_stuff.c"
void
WI_drawOnLnode
( int n,
  const char* const c[] )
{
  ...
  do
  {
    ...
    int right;
    int bottom;
    const rpatch_t* patch = R_CachePatchNum(W_GetNumForName(c[i]));
    ...
    R_UnlockPatchNum(W_GetNumForName(c[i]));
  ...
  if (fits && i<2)
  {
    ...
    V_DrawNumPatch(lnodes[wbs->epsd][n].x,lnodes[wbs->epsd][n].y,0,W_GetNumForName(c[i]),CR_RED,VPT_STRETCH)
                                         ;
  }
  else
  {
...
# 566 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 603 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 660 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_drawAnimatedBack(void)
{
  ...
  for (i=0 ; i<NUMANIMS[wbs->epsd] ; i++)
  {
    ...
    if (a->ctr >= 0)
      ...
      V_DrawNumPatch(a->loc.x, a->loc.y, 0, a->p[a->ctr].lumpnum, CR_RED, VPT_STRETCH);
  }
}
# 691 "c:/devl/prboom3ds/src/wi_stuff.c"
static int WI_drawNum (int x, int y, int n, int digits)
{
  ...
  while (digits--)
  {
    ...
    V_DrawNumPatch(x, y, 0, num[ n % 10 ].lumpnum, CR_RED, VPT_STRETCH);
    n /= 10;
  }
  ...
  if (neg)
    ...
    V_DrawNumPatch(x-=8,y,0,W_GetNumForName(wiminus),CR_RED,VPT_STRETCH);

  return x;
}
# 752 "c:/devl/prboom3ds/src/wi_stuff.c"
static void WI_drawPercent(int x, int y, int p)
{
  ...
  V_DrawNumPatch(x,y,0,W_GetNumForName(percent),CR_RED,VPT_STRETCH);
  WI_drawNum(x, y, p, -1);
}
# 774 "c:/devl/prboom3ds/src/wi_stuff.c"
static void WI_drawTime(int x, int y, int t)
{
  ...
  if (t < 100*60*60)
    for(;;) {
      n = t % 60;
      t /= 60;
      x = WI_drawNum(x, y, n, (t || n>9) ? 2 : 1) - R_NumPatchWidth(W_GetNumForName(colon));


      if (t)

        V_DrawNumPatch(x,y,0,W_GetNumForName(colon),CR_RED,VPT_STRETCH);
      else break;
    }
  else
    V_DrawNumPatch(x - R_NumPatchWidth(W_GetNumForName(sucks)),y,0,W_GetNumForName(sucks),CR_RED,VPT_STRETCH)
                                              ;
}
# 805 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_End(void)
{
  if (deathmatch)
...
# 822 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 838 "c:/devl/prboom3ds/src/wi_stuff.c"
static void WI_drawTimeStats(int cnt_time, int cnt_total_time, int cnt_par)
{
  V_DrawNumPatch(8,160,0,W_GetNumForName(time1),CR_RED,VPT_STRETCH);
  WI_drawTime(320/2 - 8, 160, cnt_time);

  V_DrawNumPatch(8,(160 +200)/2,0,W_GetNumForName(total),CR_RED,VPT_STRETCH);
  WI_drawTime(320/2 - 8, (160 +200)/2, cnt_total_time);
  ...
  if (!(modifiedgame && !deh_pars))
  {
    if (wbs->epsd < 3)
    {
      V_DrawNumPatch(320/2 + 8,160,0,W_GetNumForName(par),CR_RED,VPT_STRETCH);
      WI_drawTime(320 - 8, 160, cnt_par);
    }
  }
}
...
static boolean snl_pointeron = 0;
# 885 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_initShowNextLoc(void)
{
  ...
  state = ShowNextLoc;
  acceleratestage = 0;
# 903 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 918 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 935 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 993 "c:/devl/prboom3ds/src/wi_stuff.c"
...
static short int **dm_frags;
static short int *dm_totals;
# 1026 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_initDeathmatchStats(void)
{
  int i;


  dm_frags = Z_Calloc(4,sizeof(*dm_frags),PU_STATIC,0);
  dm_totals = Z_Calloc(4,sizeof(*dm_totals),PU_STATIC,0);
  ...
  for (i=0 ; i<4 ; i++)
  {
    if (playeringame[i])
    {
      ...
      dm_frags[i] = Z_Calloc(4,sizeof(**dm_frags),PU_STATIC,0);
...
# 1060 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 1077 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 1185 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_drawDeathmatchStats(void)
{
  ...
  int lh;
  int halfface = R_NumPatchWidth(W_GetNumForName(facebackp))/2;
  ...
  V_DrawNumPatch(269 -R_NumPatchWidth(W_GetNumForName(total))/2,68 -33 +10,0,W_GetNumForName(total),CR_RED,VPT_STRETCH)
                                                                   ;

  V_DrawNumPatch(10,100,0,W_GetNumForName(killers),CR_RED,VPT_STRETCH);
  V_DrawNumPatch(5,50,0,W_GetNumForName(victims),CR_RED,VPT_STRETCH);
  ...
  for (i=0 ; i<4 ; i++)
  {
    if (playeringame[i]) {
      ...
      V_DrawNumPatch(x-halfface,68 - 33,0,W_GetNumForName(facebackp),i ? CR_LIMIT+i : CR_RED,VPT_STRETCH | (i ? VPT_TRANS : 0))

                                           ;
      V_DrawNumPatch(42 -halfface,y,0,W_GetNumForName(facebackp),i ? CR_LIMIT+i : CR_RED,VPT_STRETCH | (i ? VPT_TRANS : 0))

                                           ;

      if (i == me)
      {
        V_DrawNumPatch(x-halfface,68 - 33,0,W_GetNumForName(bstar),CR_RED,VPT_STRETCH)
                                              ;
        V_DrawNumPatch(42 -halfface,y,0,W_GetNumForName(star),CR_RED,VPT_STRETCH)
                                             ;
      }
    }
    x += 40;
...
# 1283 "c:/devl/prboom3ds/src/wi_stuff.c"
...
static void WI_endNetgameStats(void)
{
  Z_Free(cnt_frags); cnt_frags = ((void *)0);
  Z_Free(cnt_secret); cnt_secret = ((void *)0);
  Z_Free(cnt_items); cnt_items = ((void *)0);
  Z_Free(cnt_kills); cnt_kills = ((void *)0);
}
...
void WI_initNetgameStats(void)
{
  ...
  cnt_kills = Z_Calloc(4,sizeof(*cnt_kills),PU_STATIC,0);
  cnt_items = Z_Calloc(4,sizeof(*cnt_items),PU_STATIC,0);
  cnt_secret= Z_Calloc(4,sizeof(*cnt_secret),PU_STATIC,0);
  cnt_frags = Z_Calloc(4,sizeof(*cnt_frags),PU_STATIC,0);
...
# 1343 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 1509 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_drawNetgameStats(void)
{
  int i;
  int x;
  int y;
  int pwidth = R_NumPatchWidth(W_GetNumForName(percent));
  int fwidth = R_NumPatchWidth(W_GetNumForName(facebackp));
  ...
  V_DrawNumPatch((32 + R_NumPatchWidth(W_GetNumForName(star))/2 + 32*!dofrags)+64 -R_NumPatchWidth(W_GetNumForName(kills)),50,0,W_GetNumForName(kills),CR_RED,VPT_STRETCH)
                                                   ;

  V_DrawNumPatch((32 + R_NumPatchWidth(W_GetNumForName(star))/2 + 32*!dofrags)+2*64 -R_NumPatchWidth(W_GetNumForName(items)),50,0,W_GetNumForName(items),CR_RED,VPT_STRETCH)
                                                   ;

  V_DrawNumPatch((32 + R_NumPatchWidth(W_GetNumForName(star))/2 + 32*!dofrags)+3*64 -R_NumPatchWidth(W_GetNumForName(secret)),50,0,W_GetNumForName(secret),CR_RED,VPT_STRETCH)
                                                    ;

  if (dofrags)
    V_DrawNumPatch((32 + R_NumPatchWidth(W_GetNumForName(star))/2 + 32*!dofrags)+4*64 -R_NumPatchWidth(W_GetNumForName(frags)),50,0,W_GetNumForName(frags),CR_RED,VPT_STRETCH)
                                                     ;


  y = 50 + R_NumPatchHeight(W_GetNumForName(kills));
  ...
  for (i=0 ; i<4 ; i++)
  {
    ...
    x = (32 + R_NumPatchWidth(W_GetNumForName(star))/2 + 32*!dofrags);
    V_DrawNumPatch(x-fwidth,y,0,W_GetNumForName(facebackp),i ? CR_LIMIT+i : CR_RED,VPT_STRETCH | (i ? VPT_TRANS : 0))

                                         ;

    if (i == me)
      V_DrawNumPatch(x-fwidth,y,0,W_GetNumForName(star),CR_RED,VPT_STRETCH);
  ...
  if (y <= 160)
    ...
    WI_drawTimeStats(plrs[me].stime / 35, wbs->totaltimes / 35, wbs->partime / 35);
}

static int sp_state;
# 1587 "c:/devl/prboom3ds/src/wi_stuff.c"
...
void WI_updateStats(void)
{
  ...
  if (acceleratestage && sp_state != 10)
  {
    ...
    cnt_total_time = wbs->totaltimes / 35;
 ...
 cnt_secret[0] >= (wbs->maxsecret ?
  ...
  {
    int time_done, total_done, par_done;
    int time_just, total_just, par_just;
# 1690 "c:/devl/prboom3ds/src/wi_stuff.c"
    (time_just) = ((cnt_time) >= ((plrs[me].stime / 35))); (cnt_time) += (3); (time_done) = ((cnt_time) >= ((plrs[me].stime / 35))); (time_just) = (!(time_just) && (time_done)); if ((time_done)) (cnt_time) = ((plrs[me].stime / 35));
                             ;
    (total_just) = ((cnt_total_time) >= ((wbs->totaltimes / 35))); (cnt_total_time) += (3); (total_done) = ((cnt_total_time) >= ((wbs->totaltimes / 35))); (total_just) = (!(total_just) && (total_done)); if ((total_done)) (cnt_total_time) = ((wbs->totaltimes / 35));
                               ;
    (par_just) = ((cnt_par) >= ((wbs->partime / 35))); (cnt_par) += (3); (par_done) = ((cnt_par) >= ((wbs->partime / 35))); (par_just) = (!(par_just) && (par_done)); if ((par_done)) (cnt_par) = ((wbs->partime / 35));
                           ;
...
# 1761 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_drawStats(void)
{
  ...
  V_DrawNumPatch(50,50,0,W_GetNumForName(kills),CR_RED,VPT_STRETCH);
  if (cnt_kills)
    WI_drawPercent(320 - 50, 50, cnt_kills[0]);

  V_DrawNumPatch(50,50 +lh,0,W_GetNumForName(items),CR_RED,VPT_STRETCH);
  if (cnt_items)
    WI_drawPercent(320 - 50, 50 +lh, cnt_items[0]);

  V_DrawNumPatch(50,50 +2*lh,0,W_GetNumForName(sp_secret),CR_RED,VPT_STRETCH);
  if (cnt_secret)
    WI_drawPercent(320 - 50, 50 +2*lh, cnt_secret[0]);

  WI_drawTimeStats(cnt_time, cnt_total_time, cnt_par);
}
# 1798 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 1836 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_Ticker(void)
{
...
# 1882 "c:/devl/prboom3ds/src/wi_stuff.c"
...
# 1931 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_Drawer (void)
{
  switch (state)
  {
...
# 1962 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_initVariables(wbstartstruct_t* wbstartstruct)
{

  wbs = wbstartstruct;
# 1984 "c:/devl/prboom3ds/src/wi_stuff.c"
  acceleratestage = 0;
  cnt = bcnt = 0;
  firstrefresh = 1;
  me = wbs->pnum;
...
# 2009 "c:/devl/prboom3ds/src/wi_stuff.c"
void WI_Start(wbstartstruct_t* wbstartstruct)
{
