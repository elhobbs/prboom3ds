# 1 "c:/devl/prboom3ds/src/r_demo.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/r_demo.c"
# 35 "c:/devl/prboom3ds/src/r_demo.c"
...
# 36 "c:/devl/prboom3ds/src/r_demo.c" 2
...
# 37 "c:/devl/prboom3ds/src/r_demo.c" 2
...
# 38 "c:/devl/prboom3ds/src/r_demo.c" 2

int demo_smoothturns = 0;
int demo_smoothturnsfactor = 6;

static int smooth_playing_turns[16];
...
void R_SmoothPlaying_Reset(player_t *player)
{
  if (demo_smoothturns && demoplayback)
  {
    ...
    if (player==&players[displayplayer])
    {
      ...
      memset(smooth_playing_turns, 0, sizeof(smooth_playing_turns[0]) * 16);
