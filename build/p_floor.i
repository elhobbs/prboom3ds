# 1 "c:/devl/prboom3ds/src/p_floor.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_floor.c"
# 35 "c:/devl/prboom3ds/src/p_floor.c"
...
# 36 "c:/devl/prboom3ds/src/p_floor.c" 2
...
# 37 "c:/devl/prboom3ds/src/p_floor.c" 2
...
# 38 "c:/devl/prboom3ds/src/p_floor.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_floor.c" 2
...
# 40 "c:/devl/prboom3ds/src/p_floor.c" 2
...
extern int idmusnum;
# 41 "c:/devl/prboom3ds/src/p_floor.c" 2
...
# 42 "c:/devl/prboom3ds/src/p_floor.c" 2
# 65 "c:/devl/prboom3ds/src/p_floor.c"
result_e T_MovePlane
( sector_t* sector,
  fixed_t speed,
  fixed_t dest,
...
# 235 "c:/devl/prboom3ds/src/p_floor.c"
...
# 346 "c:/devl/prboom3ds/src/p_floor.c"
...
# 424 "c:/devl/prboom3ds/src/p_floor.c"
int EV_DoFloor
( line_t* line,
  floor_e floortype )
{
  ...
  while ((secnum = P_FindSectorFromLineTag(line,secnum)) >= 0)
  {
    ...
    switch(floortype)
    {
      ...
      case lowerFloor32Turbo:
        ...
        floor->sector = sec;
        floor->speed = (1<<16)*4;
        floor->floordestheight = floor->sector->floorheight + 32 * (1<<16);
        break;
      ...
      case raiseFloor:
        ...
        floor->floordestheight -= (8*(1<<16))*(floortype == raiseFloorCrush);
        break;
      ...
      case raiseToTexture:
        {
          ...
          if (!comp[comp_model]) minsize = 32000<<16;
          floor->direction = 1;
          floor->sector = sec;
          floor->speed = (1<<16);
          ...
          {
            floor->floordestheight =
              (floor->sector->floorheight>>16) + (minsize>>16);
            if (floor->floordestheight>32000)
              floor->floordestheight = 32000;
            floor->floordestheight<<=16;
          }
        }
      break;
...
# 648 "c:/devl/prboom3ds/src/p_floor.c"
int EV_DoChange
( line_t* line,
  change_e changetype )
{
...
# 713 "c:/devl/prboom3ds/src/p_floor.c"
  ...
  while ((ssec = P_FindSectorFromLineTagWithLowerBound(line,ssec,minssec)) >= 0)
  {
   ...
   if (comp[comp_stairs]) {
     ...
     if ((compatibility_level >= mbf_compatibility) && (compatibility_level <
           prboom_3_compatibility)) ssec = secnum;
     else {
...
# 881 "c:/devl/prboom3ds/src/p_floor.c"
...
# 974 "c:/devl/prboom3ds/src/p_floor.c"
int EV_DoElevator
( line_t* line,
  elevator_e elevtype )
{
