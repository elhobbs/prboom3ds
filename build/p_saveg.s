...
P_ArchivePlayers:
.LFB4:
	.file 1 "c:/devl/prboom3ds/src/p_saveg.c"
	.loc 1 54 0
	.cfi_startproc
...
.LVL7:
	...
	cmp	r2, #0
	.loc 1 100 0
	rsbne	r2, r2, r2, asl #3
	addne	r2, r9, r2, asl #2
	.loc 1 99 0
	strne	r2, [r0, #248]
	.loc 1 98 0
	ldr	r2, [r0, #264]
...
.LVL31:
	.loc 1 171 0
	mov	ip, r1
	ldr	r8, [ip], #4	@ unaligned
	str	r8, [r3, #-14]	@ unaligned
.LVL32:
	.loc 1 173 0
	ldr	ip, [ip]	@ unaligned
	str	ip, [r3, #-10]	@ unaligned
	.loc 1 176 0
	ldrh	ip, [r1, #8]
	strh	ip, [r3, #-6]	@ movhi
	.loc 1 177 0
...
.LBB30:
	...
	ldr	r0, [r8]
	.loc 1 236 0
	ldr	r9, [lr], #4	@ unaligned
	.loc 1 232 0
	add	r3, r3, r3, asl #4
	.loc 1 236 0
	str	r9, [r0, r3, asl #2]	@ unaligned
	.loc 1 238 0
	ldr	lr, [lr]	@ unaligned
	.loc 1 232 0
	add	r3, r0, r3, asl #2
...
.LFE7:
	...
	.align	2
	.global	P_ThinkerToIndex
	.type	P_ThinkerToIndex, %function
P_ThinkerToIndex:
.LFB8:
	.loc 1 264 0
	.cfi_startproc
...
.L77:
	...
	.cfi_endproc
.LFE8:
	.size	P_ThinkerToIndex, .-P_ThinkerToIndex
	.align	2
	.global	P_IndexToThinker
	.type	P_IndexToThinker, %function
P_IndexToThinker:
.LFB9:
	.loc 1 281 0
	.cfi_startproc
...
.L84:
	...
	.cfi_endproc
.LFE9:
	.size	P_IndexToThinker, .-P_IndexToThinker
	.align	2
...
.L92:
	...
	ldreq	r2, [r2]	@ unaligned
	streq	r2, [r9, #188]	@ unaligned
.L94:
	.loc 1 372 0
	ldr	r2, [r8, #156]
	.loc 1 370 0
...
.LVL94:
	...
	movne	r6, #4
	bne	.L127
	.loc 1 456 0 is_stmt 0 discriminator 3
	mov	r2, r8
.LVL95:
.L132:
	...
	ldrb	r2, [r3, #204]	@ zero_extendqisi2
	add	r0, r0, #1
.LVL96:
	cmp	r2, #1
	add	r2, r3, #205
...
.L176:
	...
	cmpne	r2, r8
	beq	.L229
	.loc 1 621 0 discriminator 11
	ldr	r5, .L277+36
	cmp	r2, r5
	moveq	r2, #44
	beq	.L187
	.loc 1 621 0 discriminator 13
	ldr	r5, .L277+40
	cmp	r2, r5
	beq	.L229
	.loc 1 621 0 discriminator 17
	ldr	r5, .L277+44
	ldr	r10, .L277+48
	cmp	r2, r5
	cmpne	r2, r10
	beq	.L230
	.loc 1 621 0 discriminator 19
	ldr	r5, .L277+52
	cmp	r2, r5
	moveq	r2, #44
	movne	r2, #0
...
.LVL168:
	...
	b	.L192
.L276:
	.loc 1 649 0 is_stmt 0 discriminator 2
	ldr	r2, [r2, #4]
.LVL169:
	cmp	r2, #0
	beq	.L192
...
.L331:
	...
	.cfi_endproc
.LFE16:
	.size	P_ArchiveRNG, .-P_ArchiveRNG
	.align	2
	.global	P_UnArchiveRNG
	.type	P_UnArchiveRNG, %function
P_UnArchiveRNG:
.LFB17:
	.loc 1 973 0
	.cfi_startproc
...
.L335:
	...
	.cfi_endproc
.LFE17:
	.size	P_UnArchiveRNG, .-P_UnArchiveRNG
	.align	2
	.global	P_ArchiveMap
	.type	P_ArchiveMap, %function
P_ArchiveMap:
.LFB18:
	.loc 1 981 0
	.cfi_startproc
...
.L343:
	...
	.cfi_endproc
.LFE18:
	.size	P_ArchiveMap, .-P_ArchiveMap
	.align	2
	.global	P_UnArchiveMap
	.type	P_UnArchiveMap, %function
P_UnArchiveMap:
.LFB19:
	.loc 1 1006 0
	.cfi_startproc
...
.L363:
	...
	.word	automapmode
	.word	markpointnum
	.word	markpointnum_max
	.word	markpoints
	.cfi_endproc
.LFE19:
	.size	P_UnArchiveMap, .-P_UnArchiveMap
	.comm	specials_e,1,1
	.comm	save_p,4,4
	.section	.rodata.str1.4,"aMS",%progbits,1
	.align	2
.LC0:
	.ascii	"c:/devl/prboom3ds/src/p_saveg.c\000"
.LC1:
	.ascii	"P_UnArchiveThinkers: Unknown tclass %i in savegame\000"
	.space	1
.LC2:
	.ascii	"Corrupt savegame\000"
	.space	3
.LC3:
	.ascii	"P_UnarchiveSpecials: Unknown tclass %i in savegame\000"
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
	.type	number_of_thinkers, %object
	.size	number_of_thinkers, 4
number_of_thinkers:
	.space	4
	.text
.Letext0:
	...
	.file 20 "c:/devl/prboom3ds/src/am_map.h"
	.file 21 "c:/devl/prboom3ds/src/p_enemy.h"
	.file 22 "c:/devl/prboom3ds/src/r_state.h"
	.file 23 "c:/devl/prboom3ds/src/p_saveg.h"
