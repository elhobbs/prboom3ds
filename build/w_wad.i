# 1 "c:/devl/prboom3ds/src/w_wad.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/w_wad.c"
# 46 "c:/devl/prboom3ds/src/w_wad.c"
...
# 8 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\_default_fcntl.h" 2 3
...
# 180 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\_default_fcntl.h" 2 3
...
# 47 "c:/devl/prboom3ds/src/w_wad.c" 2
...
# 49 "c:/devl/prboom3ds/src/w_wad.c" 2
...
# 50 "c:/devl/prboom3ds/src/w_wad.c" 2
...
# 52 "c:/devl/prboom3ds/src/w_wad.c" 2
...
# 57 "c:/devl/prboom3ds/src/w_wad.c" 2
...
# 58 "c:/devl/prboom3ds/src/w_wad.c" 2
...
void ExtractFileBase (const char *path, char *dest)
{
  ...
  {
    *dest++ = __extension__ ({ __typeof__ (*src) __x = (*src); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;});
    *src++;
  }
...
# 128 "c:/devl/prboom3ds/src/w_wad.c"
...

{
  ...
  int length;
  int startlump;
  filelump_t *fileinfo, *fileinfo2free=((void *)0);
 ...
 I_Error("W_AddFile: couldn't open %s",wadfile->name);
  ...
  if ( strlen(wadfile->name)<=4 ||
     ...
     )
    {
      ...
      singleinfo.size = (long int)(I_Filelength(wadfile->handle));
   ...
   header.infotableofs = (long int)(header.infotableofs);
      ...
      fileinfo2free = fileinfo = Z_Malloc(length,PU_STATIC,0);
      fseek(wadfile->handle, header.infotableofs, 0);
    ...
    for (i=startlump ; (int)i<numlumps ; i++,lump_p++, fileinfo++)
      {
        ...
        lump_p->position = (long int)(fileinfo->filepos);
        lump_p->size = (long int)(fileinfo->size);
...
# 227 "c:/devl/prboom3ds/src/w_wad.c"
  ...
  if (mark_end)
    {
      ...
      lumpinfo[numlumps].wadfile = ((void *)0);
...
{
  unsigned hash;
  (void) ((hash = __extension__ ({ __typeof__ (s[0]) __x = (s[0]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}), s[1]) &&
          (hash = hash*3+__extension__ ({ __typeof__ (s[1]) __x = (s[1]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}), s[2]) &&
          (hash = hash*2+__extension__ ({ __typeof__ (s[2]) __x = (s[2]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}), s[3]) &&
          (hash = hash*2+__extension__ ({ __typeof__ (s[3]) __x = (s[3]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}), s[4]) &&
          (hash = hash*2+__extension__ ({ __typeof__ (s[4]) __x = (s[4]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}), s[5]) &&
          (hash = hash*2+__extension__ ({ __typeof__ (s[5]) __x = (s[5]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}), s[6]) &&
          (hash = hash*2+__extension__ ({ __typeof__ (s[6]) __x = (s[6]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}),
           hash = hash*2+__extension__ ({ __typeof__ (s[7]) __x = (s[7]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}))
         );
  return hash;
}
# 331 "c:/devl/prboom3ds/src/w_wad.c"
int (W_FindNumFromName)(const char *name, int li_namespace, int i)
{
  ...
  else
  {
    if (i < 0)
      ...
      i = lumpinfo[i].next;
# 354 "c:/devl/prboom3ds/src/w_wad.c"
...
void W_HashLumps(void)
{
  ...
  for (i=0; i<numlumps; i++)
    {
      j = W_LumpNameHash(lumpinfo[i].name) % (unsigned) numlumps;
      lumpinfo[i].next = lumpinfo[j].index;
      lumpinfo[j].index = i;
  }
}
# 396 "c:/devl/prboom3ds/src/w_wad.c"
int W_GetNumForName (const char* name)
{
...
int W_ListNumFromName(const char *name, int lump)
{
  ...
  for (i = -1; (next = (W_FindNumFromName)(name, ns_global, i)) >= 0; i = next)
    if (next == lump)
      break;

  return i;
}
# 435 "c:/devl/prboom3ds/src/w_wad.c"
wadfile_info_t *wadfiles=((void *)0);
...
void W_ReadLump(int lump, void *dest)
{
  lumpinfo_t *l = lumpinfo + lump;
...

    {
      if (l->wadfile)
      {
        fseek(l->wadfile->handle, l->position, 0);
