# 1 "c:/devl/prboom3ds/src/g_game.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/g_game.c"
# 38 "c:/devl/prboom3ds/src/g_game.c"
...
# 41 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 13 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h" 3
# 1 "c:\\devkitpro\\devkitarm\\lib\\gcc\\arm-none-eabi\\4.9.2\\include\\stddef.h" 1 3 4
...
# 48 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 50 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 54 "c:/devl/prboom3ds/src/z_zone.h"
...
# 56 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 57 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 58 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 59 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 60 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 61 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 62 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 63 "c:/devl/prboom3ds/src/g_game.c" 2
# 1 "c:/devl/prboom3ds/src/p_saveg.h" 1
# 43 "c:/devl/prboom3ds/src/p_saveg.h"
...
# 64 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 65 "c:/devl/prboom3ds/src/g_game.c" 2
# 1 "c:/devl/prboom3ds/src/p_map.h" 1
# 37 "c:/devl/prboom3ds/src/p_map.h"
...
# 38 "c:/devl/prboom3ds/src/p_map.h" 2
...
# 66 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 67 "c:/devl/prboom3ds/src/g_game.c" 2
# 1 "c:/devl/prboom3ds/src/d_main.h" 1
# 38 "c:/devl/prboom3ds/src/d_main.h"
...
# 68 "c:/devl/prboom3ds/src/g_game.c" 2
...
void WI_End(void);
# 69 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 70 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 71 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 72 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 74 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 75 "c:/devl/prboom3ds/src/g_game.c" 2
...
extern int idmusnum;
# 77 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 78 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 79 "c:/devl/prboom3ds/src/g_game.c" 2

# 1 "c:/devl/prboom3ds/src/r_sky.h" 1
# 49 "c:/devl/prboom3ds/src/r_sky.h"
extern int skytexture;
extern int skytexturemid;


void R_InitSkyMap(void);
# 81 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 82 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 83 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 84 "c:/devl/prboom3ds/src/g_game.c" 2
# 1 "c:/devl/prboom3ds/src/lprintf.h" 1
# 39 "c:/devl/prboom3ds/src/lprintf.h"
typedef enum
{
  LO_INFO=1,
  LO_CONFIRM=2,
...
# 85 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 86 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 87 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 88 "c:/devl/prboom3ds/src/g_game.c" 2
...
# 89 "c:/devl/prboom3ds/src/g_game.c" 2




static size_t savegamesize = 0x20000;
static boolean netdemo;
static const byte *demobuffer;
static int demolength;
static FILE *demofp;
static const byte *demo_p;
static short consistancy[4][12];
...
static boolean forced_loadgame = 0;
static boolean command_loadgame = 0;
...
static boolean gamekeydown[512];
static int turnheld;
...
{
  static int c;
  if (!b || !(compatibility_level < boom_compatibility_compatibility) || longtics) return b;
  if (++c & 0x1f) return b;
  b |= 1; if (b>2) b-=2;
  return b;
}
...
void G_BuildTiccmd(ticcmd_t* cmd)
{
  ...
  speed = (gamekeydown[key_speed] || joybuttons[joybspeed] ? !autorun : autorun);
  ...
  if (gamekeydown[key_reverse])
    {
      cmd->angleturn += (short)32768;
      gamekeydown[key_reverse] = 0;
    }
...
# 395 "c:/devl/prboom3ds/src/g_game.c"
  if ((!(compatibility_level < boom_compatibility_compatibility) && players[consoleplayer].attackdown &&
  ...
  else
    {
      newweapon =
        ...
        (!(compatibility_level < boom_compatibility_compatibility) && gamekeydown[key_weapon9] && gamemode == commercial) ? wp_supershotgun :
        wp_nochange;
# 423 "c:/devl/prboom3ds/src/g_game.c"
  ...
  if (mouse_double_click_use &&
      mousebuttons[mousebforward] != dclickstate && dclicktime > 1 )
    {
  ...
  if (mouse_double_click_use && bstrafe != dclickstate2 && dclicktime2 > 1 )
    {
...
# 1 "c:/devl/prboom3ds/src/z_bmalloc.h" 1
# 34 "c:/devl/prboom3ds/src/z_bmalloc.h"
...
# 549 "c:/devl/prboom3ds/src/g_game.c" 2
...
static void G_DoLoadLevel (void)
{
  ...
  {
    extern struct block_memory_alloc_s secnodezone;
    secnodezone.firstpool = ((void *)0);
...
boolean G_Responder (event_t* ev)
{
  ...
  if (ev->data1 == key_spy && netgame && (demoplayback || !deathmatch) &&
    ...
    {
      if (ev->type == ev_keyup)
  gamekeydown[key_spy] = 0;
      if (ev->type == ev_keydown && !gamekeydown[key_spy])
  {
    gamekeydown[key_spy] = 1;
    do
      if (++displayplayer >= 4)
        displayplayer = 0;
...
# 685 "c:/devl/prboom3ds/src/g_game.c"
...
void G_Ticker (void)
{
  ...
  if (!demoplayback && mapcolor_plyr[consoleplayer] != mapcolor_me) {
    ...
    int net_cl = (long int)(mapcolor_me);
      ...
      if (playeringame[i])
        {
          ...
          if ((netgame || demoplayback) && cmd->forwardmove > 0x32 &&
...
# 972 "c:/devl/prboom3ds/src/g_game.c"
...
# 991 "c:/devl/prboom3ds/src/g_game.c"
void G_ChangedPlayerColour(int pn, int cl)
{
  int i;
  ...
  for (i=0; i<4; i++) {
    if ((gamestate == GS_LEVEL) && playeringame[i] && (players[i].mo != ((void *)0))) {
      players[i].mo->flags &= ~(uint_64_t)(0x000000000c000000);
      players[i].mo->flags |= playernumtotrans[i] << 26;
    }
  }
}
...
# 1063 "c:/devl/prboom3ds/src/g_game.c"
static boolean G_CheckSpot(int playernum, mapthing_t *mthing)
{
  ...
  x = mthing->x << 16;
  y = mthing->y << 16;
# 1089 "c:/devl/prboom3ds/src/g_game.c"
  players[playernum].mo->flags |= (uint_64_t)(0x0000000000000002);
 ...
 P_RemoveMobj(bodyque[bodyqueslot % bodyquesize]);
  ...
  ss = R_PointInSubsector (x,y);
  {
    ...
    an = ( 0x20000000 * ((signed)mthing->angle/45) ) >> 19;
    xa = finecosine[an];
    ya = finesine[an];
    ...
    if (compatibility_level <= finaldoom_compatibility || compatibility_level == prboom_4_compatibility)
      ...
      case -4096: xa = finetangent[2048];
           ya = finetangent[0];
           break;
      case -3072: xa = finetangent[3072];
           ya = finetangent[1024];
           break;
      case -2048: xa = finesine[0];
           ya = finetangent[2048];
           break;
      case -1024: xa = finesine[1024];
           ya = finetangent[3072];
           break;
      case 1024:
      case 2048:
...
# 1441 "c:/devl/prboom3ds/src/g_game.c"
extern boolean setsizeneeded;
# 1451 "c:/devl/prboom3ds/src/g_game.c"
static uint_64_t G_UpdateSignature(uint_64_t s, const char *name)
{
  int i, lump = (W_CheckNumForName)(name, ns_global);
...
void G_DoLoadGame(void)
{
  ...
  length = G_SaveGameName(((void *)0), 0, savegameslot, demoplayback);
  name = Z_Malloc(length+1,PU_STATIC,0);
...

  {
    ...
    if (memcmp(&checksum, save_p, sizeof checksum)) {
      if (!forced_loadgame) {
        char *msg = Z_Malloc(strlen(save_p + sizeof checksum) + 128,PU_STATIC,0);
...
# 1750 "c:/devl/prboom3ds/src/g_game.c"
  size += 1024;
  if (pos+size > savegamesize)
    save_p = (savebuffer = Z_Realloc(savebuffer,savegamesize += (size+1023) & ~1023,PU_STATIC,0)
                                               ) + pos;
}
...
static void G_DoSaveGame (boolean menu)
{
  ...
  length = G_SaveGameName(((void *)0), 0, savegameslot, demoplayback && !menu);
  name = Z_Malloc(length+1,PU_STATIC,0);
  ...
  (CheckSaveGame)(24 +16 +sizeof(uint_64_t), "c:/devl/prboom3ds/src/g_game.c", 1785);
    ...
    for (i = 0; i<numwadfiles; i++)
      {
        ...
        (CheckSaveGame)(strlen(w)+2, "c:/devl/prboom3ds/src/g_game.c", 1814);
        strcpy(save_p, w);
  ...
  (CheckSaveGame)(64 +32 +14, "c:/devl/prboom3ds/src/g_game.c", 1822);
...
# 1921 "c:/devl/prboom3ds/src/g_game.c"
void G_Compatibility(void)
{
  static const struct {
    complevel_t fix;
...
void G_ReloadDefaults(void)
{
  ...
  memset(playeringame+1, 0, sizeof(*playeringame)*(4 -1));
    ...
    if ((fast = fast_pending))
      {
        for (i=S_SARG_RUN1; i<=S_SARG_PAIN2; i++)
          if (states[i].tics != 1 || (compatibility_level < boom_compatibility_compatibility))
            states[i].tics >>= 1;
...
void G_RecordDemo (const char* name)
{
  char *demoname;
  usergame = 0;
  demoname = Z_Malloc(strlen(name)+4+1,PU_STATIC,0);
  ...
  if (access(demoname, 0)) {
    ...
    if (demofp) {
...

      {
        ...
        pos = G_ReadDemoHeader(buf, len, 0);
        if (pos)
        {
          fseek(demofp, pos - buf, 0);
        }
      }
...
# 2344 "c:/devl/prboom3ds/src/g_game.c"
extern int forceOldBsp;

byte *G_WriteOptions(byte *demo_p)
{
  byte *target = demo_p + 64;
...
void G_BeginRecording (void)
{
  ...
  demostart = demo_p = Z_Malloc(1000,PU_STATIC,0);
  longtics = 0;
...
static const byte* G_ReadDemoHeader(const byte *demo_p, size_t size, boolean failonerror)
{
 ...
 option_p = demo_p;
      ...
      if (CheckForOverrun(header_p, demo_p, size, 64, failonerror))
        return ((void *)0);
...
void G_DoPlayDemo(void)
{
  ...
  demo_p = G_ReadDemoHeader(demobuffer, demolength, 1);
  ...
  if (timingdemo)
    {
      ...
      I_Error ("Timed %u gametics in %u realtics = %-.1f frames per second",
               ...
               (unsigned) gametic * (double) 35 / realtics);
    }
...
# 2979 "c:/devl/prboom3ds/src/g_game.c"
void doom_printf(const char *s, ...)
{
  static char msg[1024];
  va_list v;
  __builtin_va_start(v,s);
  doom_vsnprintf(msg,sizeof(msg),s,v);
  __builtin_va_end(v);
