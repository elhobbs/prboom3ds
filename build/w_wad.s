...
.Ltext0:
	...
	.align	2
	.type	IsMarker, %function
IsMarker:
.LFB8:
	.file 1 "c:/devl/prboom3ds/src/w_wad.c"
	.loc 1 228 0
	.cfi_startproc
...
.LBE9:
	.cfi_endproc
.LFE8:
	.size	IsMarker, .-IsMarker
	.align	2
	.type	W_CoalesceMarkedResource, %function
...
.L27:
	...
	.cfi_endproc
.LFE9:
	.size	W_CoalesceMarkedResource, .-W_CoalesceMarkedResource
	.align	2
	.global	ExtractFileBase
...
.LFE5:
	...
	.align	2
	.global	AddDefaultExtension
	.type	AddDefaultExtension, %function
AddDefaultExtension:
.LFB6:
...
.L64:
	...
	.cfi_endproc
.LFE6:
	.size	AddDefaultExtension, .-AddDefaultExtension
	.align	2
	.global	W_LumpNameHash
	.type	W_LumpNameHash, %function
W_LumpNameHash:
.LFB10:
	.loc 1 295 0
	.cfi_startproc
...
.L104:
	...
	.cfi_endproc
.LFE10:
	.size	W_LumpNameHash, .-W_LumpNameHash
	.global	__aeabi_uidivmod
	.align	2
	.global	W_FindNumFromName
	.type	W_FindNumFromName, %function
W_FindNumFromName:
.LFB11:
	.loc 1 332 0
	.cfi_startproc
...
.L115:
	...
	.cfi_endproc
.LFE11:
	.size	W_FindNumFromName, .-W_FindNumFromName
	.align	2
	.global	W_HashLumps
	.type	W_HashLumps, %function
W_HashLumps:
.LFB12:
	.loc 1 371 0
	.cfi_startproc
...
.LFE13:
	...
	.align	2
	.global	W_ListNumFromName
	.type	W_ListNumFromName, %function
W_ListNumFromName:
.LFB14:
	.loc 1 410 0
	.cfi_startproc
...
.LVL126:
	...
	.cfi_endproc
.LFE14:
	.size	W_ListNumFromName, .-W_ListNumFromName
	.align	2
	.global	W_Init
	.type	W_Init, %function
W_Init:
.LFB15:
	.loc 1 440 0
	.cfi_startproc
...
.LFE15:
	.size	W_Init, .-W_Init
	.align	2
	.global	W_ReleaseAllWads
	.type	W_ReleaseAllWads, %function
W_ReleaseAllWads:
.LFB16:
	.loc 1 474 0
	.cfi_startproc
...
.L184:
	...
	.cfi_endproc
.LFE16:
	.size	W_ReleaseAllWads, .-W_ReleaseAllWads
	.align	2
	.global	W_LumpLength
...
.LC0:
	...
	.space	2
.LC1:
	.ascii	"W_GetNumForName: %.8s not found\000"
.LC2:
	.ascii	"rb\000"
	.space	1
.LC3:
...
.LC4:
	...
	.space	3
.LC5:
	.ascii	"W_AddFile: couldn't open %s\000"
.LC6:
	.ascii	" adding %s\012\000"
.LC7:
	.ascii	".wad\000"
	.space	3
.LC8:
...
.LC9:
	...
	.space	3
.LC10:
	.ascii	"W_AddFile: Wad file %s doesn't have IWAD or PWAD id"
	.ascii	"\000"
.LC11:
	.ascii	"realloc failed\000"
	.space	1
.LC12:
	.ascii	"W_Init: No files found\000"
	.space	1
.LC13:
	.ascii	"S_START\000"
.LC14:
...
.LC22:
	...
	.space	1
.LC23:
	.ascii	"W_LumpLength: %i >= numlumps\000"
	.bss
	.align	2
	.set	.LANCHOR0,. + 0
...
.Letext0:
	...
	.file 16 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\ctype.h"
	.file 17 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\string.h"
	.file 18 "c:/devl/prboom3ds/src/i_system.h"
	.file 19 "<built-in>"
...
.LASF993:
	.ascii	"S_YKEY\000"
.LASF1481:
	.ascii	"W_CoalesceMarkedResource\000"
.LASF875:
...
.LASF1385:
	.ascii	"filepos\000"
.LASF1479:
	.ascii	"c:/devl/prboom3ds/src/w_wad.c\000"
.LASF382:
