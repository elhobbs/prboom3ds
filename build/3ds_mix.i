# 1 "c:/devl/prboom3ds/arm11/source/3ds_mix.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/arm11/source/3ds_mix.c"
# 1 "c:/devl/prboom3ds/arm9/include/ds_mix.h" 1
       
# 2 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2
...
# 3 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2
...
# 4 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2
...
extern int idmusnum;
# 5 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2
...
# 6 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2
...
# 7 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2
...
# 8 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2
...
# 9 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2
...
# 10 "c:/devl/prboom3ds/arm11/source/3ds_mix.c" 2

extern int snd_card;
extern boolean nosfxparm;
# 26 "c:/devl/prboom3ds/arm11/source/3ds_mix.c"
typedef struct
{
 sfxinfo_t *sfxinfo;
 void *origin;
...
byte *c_snd_Buffer_left;
byte *c_snd_Buffer_right;
...
portable_samplepair_t paintbuffer[512];
...
void mix_start() {
 memset(c_snd_Buffer_left, 0, (8192));
 memset(c_snd_Buffer_right, 0, (8192));
 c_snd_Buffer_left[4] = c_snd_Buffer_left[5] = 0x7f;
 c_snd_Buffer_right[4] = c_snd_Buffer_right[5] = 0x7f;
 GSPGPU_FlushDataCache(((void *)0), c_snd_Buffer_left, (8192));
 GSPGPU_FlushDataCache(((void *)0), c_snd_Buffer_right, (8192));
}
...
void mix_stop() {
# 103 "c:/devl/prboom3ds/arm11/source/3ds_mix.c"
}
...
void MIX_init() {
 ...
 if (CSND_initialize(((void *)0)) == 0) {
  audio_initialized = 1;
 }
 c_snd_Buffer_left = linearAlloc((8192) * 2);
 c_snd_Buffer_right = c_snd_Buffer_left + (8192);

 mix_start();

 CSND_playsound(0x8, CSND_LOOP_ENABLE, CSND_ENCODING_PCM8, 11025, (u32*)c_snd_Buffer_left, (u32*)c_snd_Buffer_right, (8192) * 2, 2, 2);
...
void MIX_Update_(void)
{
 ...
 endtime = soundtime + snd_Speed / 10;
 samps = snd_Samples/2;
...
# 472 "c:/devl/prboom3ds/arm11/source/3ds_mix.c"
...
# 564 "c:/devl/prboom3ds/arm11/source/3ds_mix.c"
...
void S_StartSoundAtVolume(void *origin_p, int sfx_id, int volume)
{
 ...
 is_pickup = sfx_id & (0x8000) || sfx_id == sfx_oof || (compatibility_level >= prboom_2_compatibility && sfx_id == sfx_noway);
 sfx_id &= ~(0x8000);
