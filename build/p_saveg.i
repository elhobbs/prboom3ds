# 1 "c:/devl/prboom3ds/src/p_saveg.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_saveg.c"
# 34 "c:/devl/prboom3ds/src/p_saveg.c"
...
# 35 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
# 36 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
# 37 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
# 38 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
# 40 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
# 41 "c:/devl/prboom3ds/src/p_saveg.c" 2
# 1 "c:/devl/prboom3ds/src/am_map.h" 1
# 37 "c:/devl/prboom3ds/src/am_map.h"
...
# 38 "c:/devl/prboom3ds/src/am_map.h" 2
...
# 42 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
void A_RandomJump();
void A_LineEffect();
# 43 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
# 44 "c:/devl/prboom3ds/src/p_saveg.c" 2
...
void P_ArchivePlayers (void)
{
  ...
  (CheckSaveGame)(sizeof(player_t) * 4, "c:/devl/prboom3ds/src/p_saveg.c", 57);
  for (i=0 ; i<4 ; i++)
    if (playeringame[i])
      {
        int j;
        ...
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
...
void P_ArchiveWorld (void)
{
  ...
  for (i=0; i<numlines; i++)
    {
      if (lines[i].sidenum[0] != ((unsigned short)-1))
        size +=
    sizeof(short)*3 + sizeof si->textureoffset + sizeof si->rowoffset;
      if (lines[i].sidenum[1] != ((unsigned short)-1))
  size +=
    sizeof(short)*3 + sizeof si->textureoffset + sizeof si->rowoffset;
    }

  (CheckSaveGame)(size, "c:/devl/prboom3ds/src/p_saveg.c", 132);
  ...
  for (i=0, li = lines ; i<numlines ; i++,li++)
    {
      ...
      *put++ = li->tag;
      ...
      for (j=0; j<2; j++)
        if (li->sidenum[j] != ((unsigned short)-1))
          {
...
void P_IndexToThinker(void)
{
  ...
  thinker_t *th;
  thinker_t *prev = &thinkerclasscap[th_all];

  for (th = thinkerclasscap[th_all].next ; th != &thinkerclasscap[th_all] ; prev=th, th=th->next)
    th->prev = prev;
}
...
void P_ArchiveThinkers (void)
{
  ...
  (CheckSaveGame)(sizeof brain, "c:/devl/prboom3ds/src/p_saveg.c", 299);
  memcpy(save_p, &brain, sizeof brain);
  save_p += sizeof brain;
# 311 "c:/devl/prboom3ds/src/p_saveg.c"
  (CheckSaveGame)(number_of_thinkers*(sizeof(mobj_t)-3*sizeof(fixed_t)+4+3*sizeof(void*)) +1, "c:/devl/prboom3ds/src/p_saveg.c", 311);
    ...
    if (th->function == P_MobjThinker)
      {
        ...
        *save_p++ = tc_mobj;
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        mobj = (mobj_t *)save_p;
# 339 "c:/devl/prboom3ds/src/p_saveg.c"
        ...
        if (mobj->target)
          mobj->target = mobj->target->thinker.function ==
            P_MobjThinker ?
            (mobj_t *) mobj->target->thinker.prev : ((void *)0);

        if (mobj->tracer)
          mobj->tracer = mobj->tracer->thinker.function ==
            P_MobjThinker ?
            (mobj_t *) mobj->tracer->thinker.prev : ((void *)0);
  ...
  *save_p++ = tc_end;
  ...
  {
    int i;
    (CheckSaveGame)(numsectors * sizeof(mobj_t *), "c:/devl/prboom3ds/src/p_saveg.c", 382);
...
void P_UnArchiveThinkers (void)
{
  ...
  for (th = thinkerclasscap[th_all].next; th != &thinkerclasscap[th_all]; )
    {
...

  {
    ...
    *(mobj_p = Z_Malloc(size * sizeof *mobj_p,PU_STATIC,0)) = 0;
    save_p = sp;
  }
  ...
  for (size = 1; *save_p++ == tc_mobj; size++)
    {
      mobj_t *mobj = Z_Malloc(sizeof(mobj_t), PU_LEVEL, ((void *)0));


      mobj_p[size] = mobj;

      do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
# 498 "c:/devl/prboom3ds/src/p_saveg.c"
      ...
      if (!((mobj->flags ^ (uint_64_t)(0x0000000000400000)) & ((uint_64_t)0x0000000400000000ll | (uint_64_t)(0x0000000000400000) | (uint_64_t)(0x0000000000100000))))
        totallive++;
    }
...
# 593 "c:/devl/prboom3ds/src/p_saveg.c"
void P_ArchiveSpecials (void)
{
  thinker_t *th;
  size_t size = 0;
  ...
  (CheckSaveGame)(size + 1, "c:/devl/prboom3ds/src/p_saveg.c", 634);
  ...
  while ((tclass = *save_p++) != tc_endspecials)
    switch (tclass)
      ...
      case tc_ceiling:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          ceiling_t *ceiling = Z_Malloc (sizeof(*ceiling), PU_LEVEL, ((void *)0));
      ...
      case tc_door:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          vldoor_t *door = Z_Malloc (sizeof(*door), PU_LEVEL, ((void *)0));
          memcpy (door, save_p, sizeof(*door));
          save_p += sizeof(*door);
          door->sector = &sectors[(int)door->sector];


          door->line = (int)door->line!=-1? &lines[(int)door->line] : ((void *)0);
      ...
      case tc_floor:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          floormove_t *floor = Z_Malloc (sizeof(*floor), PU_LEVEL, ((void *)0));
      ...
      case tc_plat:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          plat_t *plat = Z_Malloc (sizeof(*plat), PU_LEVEL, ((void *)0));
      ...
      case tc_flash:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          lightflash_t *flash = Z_Malloc (sizeof(*flash), PU_LEVEL, ((void *)0));
      ...
      case tc_strobe:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          strobe_t *strobe = Z_Malloc (sizeof(*strobe), PU_LEVEL, ((void *)0));
      ...
      case tc_glow:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          glow_t *glow = Z_Malloc (sizeof(*glow), PU_LEVEL, ((void *)0));
      ...
      case tc_flicker:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          fireflicker_t *flicker = Z_Malloc (sizeof(*flicker), PU_LEVEL, ((void *)0));
      ...
      case tc_elevator:
        do { save_p += (4 - ((int) save_p & 3)) & 3; } while (0);
        {
          elevator_t *elevator = Z_Malloc (sizeof(*elevator), PU_LEVEL, ((void *)0));
      ...
      case tc_scroll:
        {
          scroll_t *scroll = Z_Malloc (sizeof(scroll_t), PU_LEVEL, ((void *)0));
      ...
      case tc_pusher:
        {
          pusher_t *pusher = Z_Malloc (sizeof(pusher_t), PU_LEVEL, ((void *)0));
...
void P_ArchiveRNG(void)
{
  (CheckSaveGame)(sizeof rng, "c:/devl/prboom3ds/src/p_saveg.c", 967);
...
{
  int zero = 0, one = 1;
  (CheckSaveGame)(2 * sizeof zero + sizeof markpointnum + markpointnum * sizeof *markpoints + sizeof automapmode + sizeof one,

 "c:/devl/prboom3ds/src/p_saveg.c"
# 983 "c:/devl/prboom3ds/src/p_saveg.c"
  ,
  ...
  if (markpointnum)
    {
      while (markpointnum >= markpointnum_max)
        markpoints = Z_Realloc(markpoints,sizeof *markpoints * (markpointnum_max = markpointnum_max ? markpointnum_max*2 : 16),PU_STATIC,0)
                                                                         ;
