...
.Ltext0:
	...
	.align	2
	.global	R_SmoothPlaying_Reset
	.type	R_SmoothPlaying_Reset, %function
R_SmoothPlaying_Reset:
.LFB4:
	.file 1 "c:/devl/prboom3ds/src/r_demo.c"
	.loc 1 48 0
	.cfi_startproc
...
.LBE4:
	.cfi_endproc
.LFE4:
	.size	R_SmoothPlaying_Reset, .-R_SmoothPlaying_Reset
	.global	__aeabi_idivmod
	.global	__aeabi_ldivmod
	.align	2
	.global	R_SmoothPlaying_Add
	.type	R_SmoothPlaying_Add, %function
R_SmoothPlaying_Add:
.LFB5:
	.loc 1 65 0
	.cfi_startproc
...
.L25:
	...
	.cfi_endproc
.LFE5:
	.size	R_SmoothPlaying_Add, .-R_SmoothPlaying_Add
	.align	2
	.global	R_SmoothPlaying_Get
	.type	R_SmoothPlaying_Get, %function
R_SmoothPlaying_Get:
.LFB6:
	.loc 1 77 0
	.cfi_startproc
...
.L31:
	...
	.cfi_endproc
.LFE6:
	.size	R_SmoothPlaying_Get, .-R_SmoothPlaying_Get
	.align	2
	.global	R_ResetAfterTeleport
	.type	R_ResetAfterTeleport, %function
R_ResetAfterTeleport:
.LFB7:
	.loc 1 85 0
	.cfi_startproc
	@ args = 0, pretend = 0, frame = 0
...
.LVL16:
	.cfi_endproc
.LFE7:
	.size	R_ResetAfterTeleport, .-R_ResetAfterTeleport
	.global	demo_smoothturnsfactor
	.global	demo_smoothturns
	.data
	.align	2
	.set	.LANCHOR1,. + 0
	.type	demo_smoothturnsfactor, %object
	.size	demo_smoothturnsfactor, 4
demo_smoothturnsfactor:
	.word	6
	.bss
	.align	3
	.set	.LANCHOR0,. + 0
	.type	demo_smoothturns, %object
	.size	demo_smoothturns, 4
demo_smoothturns:
	.space	4
	.type	smooth_playing_angle, %object
	.size	smooth_playing_angle, 4
smooth_playing_angle:
	.space	4
	.type	smooth_playing_turns, %object
	.size	smooth_playing_turns, 64
smooth_playing_turns:
	.space	64
	.type	smooth_playing_sum, %object
	.size	smooth_playing_sum, 8
smooth_playing_sum:
	.space	8
	.type	smooth_playing_index, %object
	.size	smooth_playing_index, 4
smooth_playing_index:
	.space	4
	.text
.Letext0:
	...
	.file 11 "c:/devl/prboom3ds/src/d_player.h"
	.file 12 "c:/devl/prboom3ds/src/d_ticcmd.h"
	.file 13 "c:/devl/prboom3ds/src/doomstat.h"
	.file 14 "c:/devl/prboom3ds/src/r_fps.h"
...
.LASF1549:
	.ascii	"smooth_playing_turns\000"
.LASF1498:
...
.LASF1562:
	.ascii	"c:/devl/prboom3ds/src/r_demo.c\000"
.LASF461:
...
.LASF245:
	.ascii	"S_DSGUN10\000"
.LASF1552:
	.ascii	"smooth_playing_angle\000"
.LASF36:
...
.LASF1551:
	.ascii	"smooth_playing_index\000"
.LASF465:
