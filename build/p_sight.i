# 1 "c:/devl/prboom3ds/src/p_sight.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_sight.c"
# 34 "c:/devl/prboom3ds/src/p_sight.c"
...
# 35 "c:/devl/prboom3ds/src/p_sight.c" 2
...
# 36 "c:/devl/prboom3ds/src/p_sight.c" 2
...
# 37 "c:/devl/prboom3ds/src/p_sight.c" 2
...
# 38 "c:/devl/prboom3ds/src/p_sight.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_sight.c" 2
...
# 40 "c:/devl/prboom3ds/src/p_sight.c" 2
...
# 41 "c:/devl/prboom3ds/src/p_sight.c" 2
...
inline static int P_DivlineSide(fixed_t x, fixed_t y, const divline_t *node)
{
  ...
  return
    ...
    (right = ((y - node->y) >> 16) * (node->dx >> 16)) <
    (left = ((x - node->x) >> 16) * (node->dy >> 16)) ? 0 :
    right == left ? 2 : 1;
}
# 82 "c:/devl/prboom3ds/src/p_sight.c"
static boolean P_CrossSubsector(int num)
{
  seg_t *seg = segs + subsectors[num].firstline;
  int count;
  fixed_t opentop = 0, openbottom = 0;
  const sector_t *front = ((void *)0), *back = ((void *)0);
  ...
  continue;
    ...
    if (!(line->flags & 4) || (openbottom >= opentop) ||
...
# 204 "c:/devl/prboom3ds/src/p_sight.c"
static boolean P_CrossBSPNode_LxDoom(int bspnum)
{
  ...
  return P_CrossSubsector(bspnum == -1 ? 0 : bspnum & ~0x80000000);
}
...
# 262 "c:/devl/prboom3ds/src/p_sight.c"
boolean P_CheckSight(mobj_t *t1, mobj_t *t2)
{
  ...
  case lxdoom_1_compatibility:
    ...
    break;
  default:
    los.maxz = 2147483647; los.minz = (-2147483647 - 1);
  }
