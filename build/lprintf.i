# 1 "c:/devl/prboom3ds/src/lprintf.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/lprintf.c"
# 46 "c:/devl/prboom3ds/src/lprintf.c"
...
# 47 "c:/devl/prboom3ds/src/lprintf.c" 2
...
# 50 "c:/devl/prboom3ds/src/lprintf.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 51 "c:/devl/prboom3ds/src/lprintf.c" 2
...
# 55 "c:/devl/prboom3ds/src/lprintf.c" 2
...
# 56 "c:/devl/prboom3ds/src/lprintf.c" 2
...
# 57 "c:/devl/prboom3ds/src/lprintf.c" 2
...
# 58 "c:/devl/prboom3ds/src/lprintf.c" 2

int cons_error_mask = -1-LO_INFO;
int cons_output_mask = -1;
# 328 "c:/devl/prboom3ds/src/lprintf.c"
int lprintf(OutputLevels pri, const char *s, ...)
{
  ...
  {
    r=fprintf((_impure_ptr->_stdout),"%s",msg);



  }
  if (!isatty(1) && lvl&cons_error_mask)
    r=fprintf((_impure_ptr->_stderr),"%s",msg);

  return r;
}
# 361 "c:/devl/prboom3ds/src/lprintf.c"
...
# 390 "c:/devl/prboom3ds/src/lprintf.c"
int doom_vsnprintf(char *buf, size_t max, const char *fmt, va_list va)
{
  int rv;
  va_list vc;

  (((max == 0 && buf == ((void *)0)) || (max != 0 && buf != ((void *)0))) ? (void)0 : __assert_func ("c:/devl/prboom3ds/src/lprintf.c", 395, __FUNCTION__, "(max == 0 && buf == NULL) || (max != 0 && buf != NULL)"));
  ((fmt != ((void *)0)) ? (void)0 : __assert_func ("c:/devl/prboom3ds/src/lprintf.c", 396, __FUNCTION__, "fmt != NULL"));

  __builtin_va_copy(vc,va);
  ...
  if (rv < 0)
  {
    ...
    for (; rv < 0; backsize *= 2)
    {
      ...
      ((backbuffer != ((void *)0)) ? (void)0 : __assert_func ("c:/devl/prboom3ds/src/lprintf.c", 413, __FUNCTION__, "backbuffer != NULL"));
