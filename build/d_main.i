# 1 "c:/devl/prboom3ds/src/d_main.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/d_main.c"
# 46 "c:/devl/prboom3ds/src/d_main.c"
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\unistd.h" 1 3



# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h" 1 3
...
# 9 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h" 2 3
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\types.h" 1 3
# 25 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\types.h" 3
...
# 26 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\types.h" 2 3
# 61 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\types.h" 3
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\_types.h" 1 3
# 13 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\_types.h" 3
...
# 62 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\types.h" 2 3
...
# 10 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h" 2 3



# 1 "c:\\devkitpro\\devkitarm\\lib\\gcc\\arm-none-eabi\\4.9.2\\include\\stddef.h" 1 3 4
# 14 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h" 2 3
...
# 133 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h" 3
...
pid_t vfork (void );
# 226 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h" 3
int ftruncate (int __fd, off_t __length);
int truncate (const char *, off_t __length);
# 245 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\unistd.h" 3
...
# 5 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\unistd.h" 2 3
# 47 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 10 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\time.h" 3
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\_ansi.h" 1 3
# 11 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\time.h" 2 3
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\reent.h" 1 3
# 14 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\reent.h" 3
# 1 "c:\\devkitpro\\devkitarm\\lib\\gcc\\arm-none-eabi\\4.9.2\\include\\stddef.h" 1 3 4
...
# 12 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\time.h" 2 3
...
# 50 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 51 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 49 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\stdio.h" 3
...
# 53 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 54 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 55 "c:/devl/prboom3ds/src/d_main.c" 2
# 1 "c:/devl/prboom3ds/src/d_net.h" 1
# 60 "c:/devl/prboom3ds/src/d_net.h"
typedef enum
{
    CMD_SEND = 1,
    CMD_GET = 2
...
# 113 "c:/devl/prboom3ds/src/d_net.h"
typedef struct
{
...
typedef struct
{
  netmisctype_t type;
  size_t len;
  byte value[sizeof(ticcmd_t)*12 - sizeof(netmisctype_t) - sizeof(size_t)];
} netmisc_t;
...
# 56 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 57 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 58 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 60 "c:/devl/prboom3ds/src/d_main.c" 2
...
extern int idmusnum;
# 61 "c:/devl/prboom3ds/src/d_main.c" 2
...
void V_FreeScreens();
# 62 "c:/devl/prboom3ds/src/d_main.c" 2
# 1 "c:/devl/prboom3ds/src/f_finale.h" 1
# 39 "c:/devl/prboom3ds/src/f_finale.h"
...
# 40 "c:/devl/prboom3ds/src/f_finale.h" 2
...
# 63 "c:/devl/prboom3ds/src/d_main.c" 2
# 1 "c:/devl/prboom3ds/src/f_wipe.h" 1
# 41 "c:/devl/prboom3ds/src/f_wipe.h"
int wipe_ScreenWipe (int ticks);
int wipe_StartScreen(void);
int wipe_EndScreen (void);
# 64 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 65 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 66 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 67 "c:/devl/prboom3ds/src/d_main.c" 2
# 1 "c:/devl/prboom3ds/src/p_checksum.h" 1
extern void (*P_Checksum)(int);
extern void P_ChecksumFinal(void);
void P_RecordChecksum(const char *file);
# 68 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 69 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 70 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 71 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 72 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 73 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 74 "c:/devl/prboom3ds/src/d_main.c" 2
...
void WI_End(void);
# 75 "c:/devl/prboom3ds/src/d_main.c" 2
# 1 "c:/devl/prboom3ds/src/st_stuff.h" 1
# 58 "c:/devl/prboom3ds/src/st_stuff.h"
...
# 76 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 77 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 78 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 79 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 80 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 81 "c:/devl/prboom3ds/src/d_main.c" 2
# 1 "c:/devl/prboom3ds/src/d_main.h" 1
# 46 "c:/devl/prboom3ds/src/d_main.h"
...
# 82 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 83 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 84 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 87 "c:/devl/prboom3ds/src/d_main.c" 2
...
# 149 "c:/devl/prboom3ds/src/d_main.c"
void D_PostEvent(event_t *ev)
{
...
# 173 "c:/devl/prboom3ds/src/d_main.c"
...
void D_Display (void)
{
  static boolean isborderstate = 0;
  static boolean borderwillneedredraw = 0;
  static gamestate_t oldgamestate = -1;
  boolean wipe;
  boolean viewactive = 0, isborder = 0;
  boolean once = 0;
...
drawagain:
 ...
 HU_Drawer();
  ...
  if (paused && (menuactive != mnact_full)) {
    ...
    V_DrawNumPatch((320 - R_NumPatchWidth(W_GetNumForName("M_PAUSE")))/2,4,0,W_GetNumForName("M_PAUSE"),CR_RED,VPT_STRETCH)
                                                          ;
  }
...
# 364 "c:/devl/prboom3ds/src/d_main.c"
...
static void D_PageDrawer(void)
{
  ...
  if (pagename)
  {
    V_DrawNumPatch(0,0,0,W_GetNumForName(pagename),CR_RED,VPT_STRETCH);
  }
  else
    M_DrawCredits();
}
...
# 609 "c:/devl/prboom3ds/src/d_main.c"
void D_AddFile (const char *file, wad_source_t source)
{
  char *gwa_filename=((void *)0);
...
static const char *D_dehout(void)
{
  ...
  return (p && ++p < myargc ? myargv[p] : ((void *)0));
}
# 657 "c:/devl/prboom3ds/src/d_main.c"
static void CheckIWAD(const char *iwadname,GameMode_t *gmode,boolean *hassec)
{
  if ( !access (iwadname,4) )
  {
    ...
    if ((fp = fopen(iwadname, "rb")))
    {
      ...
      if (fread(&header, sizeof(header), 1, fp) == 1 && !strncmp(header.identification, "IWAD", 4))
      {
        ...
        header.numlumps = (long int)(header.numlumps);
        header.infotableofs = (long int)(header.infotableofs);
        length = header.numlumps;
        fileinfo = Z_Malloc(length*sizeof(filelump_t),PU_STATIC,0);
        if (fseek (fp, header.infotableofs, 0) ||
...
# 751 "c:/devl/prboom3ds/src/d_main.c"
...
# 785 "c:/devl/prboom3ds/src/d_main.c"
const char *const standard_iwads_name[] =
{
 "Doom2 (French)",
 "Doom 2",
...
int wads_found_cnt = 0;
int wads_found[9] = { -1, -1, -1, -1, -1, -1, -1, -1 };
int wads_found_path[9] = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
void find_wads() {
 ...
 for (i = 0; i < nstandard_iwads; i++) {
  ...
  wads_found[wads_found_cnt++] = i;
 }

}

static void ds_game_draw() {
 int i;

 printf("searching for iwads...");
 find_wads();
 gfxFlushBuffers();
 gfxSwapBuffers();
 gspWaitForEvent(GSPEVENT_VBlank0, 0);
 ...
 for (i = 0; i < wads_found_cnt; i++) {
  iprintf("\x1b[%d;0H [ %s", 3 + i, standard_iwads_name[wads_found[i]]);
 }
 gfxFlushBuffers();
 gfxSwapBuffers();
 gspWaitForEvent(GSPEVENT_VBlank0, 0);
...
static char* ds_game_choose() {
 ...
 while (1) {
  ...
  if (pressed & KEY_UP)
  {
   ...
   if (pos < 0)
   {
    pos = wads_found_cnt-1;
   }
  }
  if (pressed & KEY_DOWN)
  {
   pos += 1;
   if (pos >= wads_found_cnt)
   {
    pos = 0;
   }
  }
...
# 910 "c:/devl/prboom3ds/src/d_main.c"
static char *FindIWADFile(void)
{
 ...
 return ds_game_choose();
    for (i=0; !iwad && i<nstandard_iwads; i++)
      iwad = I_FindFile(standard_iwads[i], ".wad");
  }
  return iwad;
}
# 947 "c:/devl/prboom3ds/src/d_main.c"
static void IdentifyVersion (void)
{
...

  {
    ...
    Z_Free(basesavegame);
    basesavegame = Z_Strdup(p,PU_STATIC,0);
  }
  if ((i=M_CheckParm("-save")) && i<myargc-1)
  {
    if (!stat(myargv[i+1],&sbuf) && (((sbuf.st_mode)&0170000) == 0040000))
    {
      Z_Free(basesavegame);
      basesavegame = Z_Strdup(myargv[i+1],PU_STATIC,0);
  ...
  iwad = FindIWADFile();
# 996 "c:/devl/prboom3ds/src/d_main.c"
  if (iwad && *iwad)
  {
...
# 1045 "c:/devl/prboom3ds/src/d_main.c"
static void FindResponseFile (void)
{
 ...
 int indexinfile;
        ...
        fname = Z_Malloc(strlen(&myargv[i][i])+4+1,PU_STATIC,0);
 ...
 size = M_ReadFile(fname, &file);
        ...
        if (size < 0)
        {
          size_t fnlen = doom_snprintf(((void *)0), 0, "%s/%s",
                                       I_DoomExeDir(), &myargv[i][1]);
          fname = Z_Realloc(fname,fnlen+4+1,PU_STATIC,0);
   ...
   newargv = Z_Calloc(sizeof(char *),100,PU_STATIC,0);
   newargv[0] = myargv[0];
...

 {
   ...
   indexinfile++;
   do {
     while (size > 0 && (((__ctype_ptr__+sizeof(""[*infile]))[(int)(*infile)])&010)) { infile++; size--; }
     if (size > 0) {
  ...
  if (!quoted && (((__ctype_ptr__+sizeof(""[*infile]))[(int)(*infile)])&010)) break;
  if (*infile == '\"') {
...
# 1183 "c:/devl/prboom3ds/src/d_main.c"
static void DoLooseFiles(void)
{
  ...
  if (wadcount+lmpcount+dehcount == 0) return;
  ...
  tmyargv = Z_Calloc(sizeof(char *),100,PU_STATIC,0);
  tmyargv[0] = myargv[0];
  tmyargc = 1;
  ...
  if (wadcount > 0)
  {
    tmyargv[tmyargc++] = Z_Strdup("-file",PU_STATIC,0);
    for (i=0;i<wadcount;)
      tmyargv[tmyargc++] = wads[i++];
  }
...
const char *wad_files[2], *deh_files[2];
  ...
  if ((p = M_CheckParm ("-cout"))) {
    ...
    if (++p != myargc && *myargv[p] != '-')
      for (i=0,cons_output_mask=0;(size_t)i<strlen(myargv[p]);i++)
        if ((pos = strchr(cena,__extension__ ({ __typeof__ (myargv[p][i]) __x = (myargv[p][i]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;})))) {
          cons_output_mask |= (1<<(pos-cena));
          lprintf(LO_DEBUG, "%c", __extension__ ({ __typeof__ (myargv[p][i]) __x = (myargv[p][i]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;}));
        }
    lprintf(LO_DEBUG, "\n");
  }
...
static void D_DoomMainSetup(void)
{
  ...
  setbuf((_impure_ptr->_stdout),((void *)0));
  ...
  M_LoadDefaults();
  lprintf(LO_INFO, "M_LoadDefaults: Load system defaults complete.\n");
  ...
  lprintf(LO_INFO, "D_BuildBEXTables: Load system defaults.\n");
  D_BuildBEXTables();
  lprintf(LO_INFO, "D_BuildBEXTables: Load system defaults complete.\n");

  lprintf(LO_INFO, "DoLooseFiles: Load system defaults.\n");
  DoLooseFiles();
  lprintf(LO_INFO, "DoLooseFiles: Load system defaults complete.\n");

  lprintf(LO_INFO, "IdentifyVersion: Load system defaults.\n");
  IdentifyVersion();
  lprintf(LO_INFO, "IdentifyVersion finished\n");


  {
    char *data_wad_path = I_FindFile("prboom" ".wad", ".wad");

    if (!data_wad_path)
      I_Error("prboom" ".wad not found - cannot continue");

    D_AddFile(data_wad_path, source_pre);
    Z_Free(data_wad_path);
  }
  lprintf(LO_INFO, "prboom.wad finished\n");
  ...
  if (devparm)
    ...
    lprintf(LO_CONFIRM,"%s","Development mode ON.\n");
  ...
  if (p)
  {
    ...
    viewangleoffset = (8-viewangleoffset) * 0x20000000;
  }



  lprintf(LO_INFO, "G_ReloadDefaults\n");
  G_ReloadDefaults();
  lprintf(LO_INFO, "G_ReloadDefaults finished\n");
  ...
  if (p && p < myargc-1)
    {
      char *file = Z_Malloc(strlen(myargv[p+1])+4+1,PU_STATIC,0);
  ...
  if (!M_CheckParm("-nodeh")) {
   ...
   for (p = -1; (p = W_ListNumFromName("DEHACKED", p)) >= 0;) {
    ...
    if (lumpinfo[p].source == source_iwad
     ...
     ProcessDehFile(((void *)0), D_dehout(), p);
    }
   }
  }
  ...
  if (!M_CheckParm ("-nodeh"))
    for (p = -1; (p = W_ListNumFromName("DEHACKED", p)) >= 0; )
      if (!(lumpinfo[p].source == source_iwad
            ...
            || lumpinfo[p].source == source_auto_load))
        ProcessDehFile(((void *)0), D_dehout(), p);
# 1739 "c:/devl/prboom3ds/src/d_main.c"
  p = M_CheckParm ("-deh");
  if (p)
  {
    char *file = ((void *)0);
    ...
    while (++p != myargc && *myargv[p] != '-')
    {
      file = Z_Realloc(file,strlen(myargv[p])+4+1,PU_STATIC,0);
    ...
    *map = 1;
    if (gamemode == commercial)
    {
      for (i=1;!done && i<33;i++)
      {
        ...
        ix = (W_CheckNumForName)(test, ns_global);
        if (ix != -1)
        {
