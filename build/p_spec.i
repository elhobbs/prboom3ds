# 1 "c:/devl/prboom3ds/src/p_spec.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_spec.c"
# 42 "c:/devl/prboom3ds/src/p_spec.c"
...
# 43 "c:/devl/prboom3ds/src/p_spec.c" 2
# 1 "c:/devl/prboom3ds/src/p_spec.h" 1
# 36 "c:/devl/prboom3ds/src/p_spec.h"
...
# 37 "c:/devl/prboom3ds/src/p_spec.h" 2
...
# 44 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 45 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 46 "c:/devl/prboom3ds/src/p_spec.c" 2
# 1 "c:/devl/prboom3ds/src/m_random.h" 1
# 62 "c:/devl/prboom3ds/src/m_random.h"
typedef enum {
  pr_skullfly,
  pr_damage,
  pr_crush,
...
# 152 "c:/devl/prboom3ds/src/m_random.h"
void M_ClearRandom(void);
# 47 "c:/devl/prboom3ds/src/p_spec.c" 2
# 1 "c:/devl/prboom3ds/src/d_englsh.h" 1
# 48 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 49 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 51 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 52 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 53 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 54 "c:/devl/prboom3ds/src/p_spec.c" 2
# 1 "c:/devl/prboom3ds/src/p_inter.h" 1
# 50 "c:/devl/prboom3ds/src/p_inter.h"
...
# 55 "c:/devl/prboom3ds/src/p_spec.c" 2
...
extern int idmusnum;
# 56 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 57 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 58 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 59 "c:/devl/prboom3ds/src/p_spec.c" 2
# 1 "c:/devl/prboom3ds/src/r_plane.h" 1
# 47 "c:/devl/prboom3ds/src/r_plane.h"
...
# 60 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 61 "c:/devl/prboom3ds/src/p_spec.c" 2
...
# 89 "c:/devl/prboom3ds/src/p_spec.c"
typedef struct
{
...
# 107 "c:/devl/prboom3ds/src/p_spec.c"
...
# 139 "c:/devl/prboom3ds/src/p_spec.c"
void P_InitPicAnims (void)
{
  ...
  for (i=0 ; animdefs[i].istexture != -1 ; i++)
  {
    ...
    if (lastanim >= anims + maxanims)
    {
      ...
      anims = Z_Realloc(anims,newmax*sizeof(*anims),PU_STATIC,0);
    ...
    lastanim->speed = (long int)(animdefs[i].speed);
    lastanim++;
  }
  W_UnlockLumpNum(lump);
}
# 208 "c:/devl/prboom3ds/src/p_spec.c"
side_t* getSide
( int currentSector,
  int line,
  int side )
...
# 226 "c:/devl/prboom3ds/src/p_spec.c"
sector_t* getSector
( int currentSector,
  int line,
  int side )
...
# 244 "c:/devl/prboom3ds/src/p_spec.c"
int twoSided
( int sector,
  int line )
{
  ...
  return comp[comp_model] ?
    ...
    :
    (sectors[sector].lines[line])->sidenum[1] != ((unsigned short)-1);
}
# 265 "c:/devl/prboom3ds/src/p_spec.c"
sector_t* getNextSector
( line_t* line,
  sector_t* sec )
{
...
# 295 "c:/devl/prboom3ds/src/p_spec.c"
...
# 326 "c:/devl/prboom3ds/src/p_spec.c"
...
# 363 "c:/devl/prboom3ds/src/p_spec.c"
...
# 398 "c:/devl/prboom3ds/src/p_spec.c"
...
# 429 "c:/devl/prboom3ds/src/p_spec.c"
...
# 460 "c:/devl/prboom3ds/src/p_spec.c"
...
# 490 "c:/devl/prboom3ds/src/p_spec.c"
fixed_t P_FindLowestCeilingSurrounding(sector_t* sec)
{
  ...
  if (!comp[comp_model]) height = 32000*(1<<16);
...
# 524 "c:/devl/prboom3ds/src/p_spec.c"
...
# 562 "c:/devl/prboom3ds/src/p_spec.c"
...
# 601 "c:/devl/prboom3ds/src/p_spec.c"
...
# 643 "c:/devl/prboom3ds/src/p_spec.c"
sector_t *P_FindModelFloorSector(fixed_t floordestheight,int secnum)
{
  ...
  for (i = 0; i < ((compatibility_level < boom_compatibility_compatibility) && sec->linecount<linecount?
...
# 686 "c:/devl/prboom3ds/src/p_spec.c"
...
# 720 "c:/devl/prboom3ds/src/p_spec.c"
...
# 773 "c:/devl/prboom3ds/src/p_spec.c"
int P_FindMinSurroundingLight
( sector_t* sector,
  int max )
{
...
# 810 "c:/devl/prboom3ds/src/p_spec.c"
boolean P_CanUnlockGenDoor
( line_t* line,
  player_t* player)
{
...
# 960 "c:/devl/prboom3ds/src/p_spec.c"
boolean __attribute__((pure)) P_SectorActive(special_e t, const sector_t *sec)
{
  if ((compatibility_level < boom_compatibility_compatibility))
    return sec->floordata != ((void *)0) || sec->ceilingdata != ((void *)0) || sec->lightingdata != ((void *)0);
  else
    switch (t)
    {
      case floor_special:
        return sec->floordata != ((void *)0);
      case ceiling_special:
        return sec->ceilingdata != ((void *)0);
      case lighting_special:
        return sec->lightingdata != ((void *)0);
    }
  return 1;
}
# 990 "c:/devl/prboom3ds/src/p_spec.c"
...
# 1069 "c:/devl/prboom3ds/src/p_spec.c"
boolean __attribute__((pure)) P_IsSecret(const sector_t *sec)
{
  return (sec->special==9 || (sec->special&0x80));
}
# 1084 "c:/devl/prboom3ds/src/p_spec.c"
boolean __attribute__((pure)) P_WasSecret(const sector_t *sec)
{
  return (sec->oldspecial==9 || (sec->oldspecial&0x80));
}
# 1111 "c:/devl/prboom3ds/src/p_spec.c"
void P_CrossSpecialLine(line_t *line, int side, mobj_t *thing)
{
  int ok;
  ...
  if (!(compatibility_level < boom_compatibility_compatibility))
  {
    ...
    if ((unsigned)line->special >= 0x8000)
    {

    }
    else if ((unsigned)line->special >= 0x6000)
    {
      if (!thing->player)
  ...
  switch (line->special)
  {
    ...
    case 2:
      ...
      if (EV_DoDoor(line,open) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 3:

      if (EV_DoDoor(line,close) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 4:

      if (EV_DoDoor(line,normal) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 5:

      if (EV_DoFloor(line,raiseFloor) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 6:

      if (EV_DoCeiling(line,fastCrushAndRaise) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 8:

      if (EV_BuildStairs(line,build8) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 10:

      if (EV_DoPlat(line,downWaitUpStay,0) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 12:

      if (EV_LightTurnOn(line,0) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 13:

      if (EV_LightTurnOn(line,255) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 16:

      if (EV_DoDoor(line,close30ThenOpen) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 17:

      if (EV_StartLightStrobing(line) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 19:

      if (EV_DoFloor(line,lowerFloor) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 22:

      if (EV_DoPlat(line,raiseToNearestAndChange,0) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 25:

      if (EV_DoCeiling(line,crushAndRaise) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;
    ...
    case 30:
      ...
      if (EV_DoFloor(line,raiseToTexture) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 35:

      if (EV_LightTurnOn(line,35) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 36:

      if (EV_DoFloor(line,turboLower) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 37:

      if (EV_DoFloor(line,lowerAndChange) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 38:

      if (EV_DoFloor(line, lowerFloorToLowest) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 39:

      if (EV_Teleport(line, side, thing) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;
    ...
    case 44:
      ...
      if (EV_DoCeiling(line, lowerAndCrush) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;
  ...
  G_ExitLevel ();
    ...
    case 53:
      ...
      if (EV_DoPlat(line,perpetualRaise,0) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 54:

      if (EV_StopPlat(line) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 56:

      if (EV_DoFloor(line,raiseFloorCrush) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 57:

      if (EV_CeilingCrushStop(line) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 58:

      if (EV_DoFloor(line,raiseFloor24) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 59:

      if (EV_DoFloor(line,raiseFloor24AndChange) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 100:

      if (EV_BuildStairs(line,turbo16) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 104:

      if (EV_TurnTagLightsOff(line) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 108:

      if (EV_DoDoor(line,blazeRaise) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 109:

      if (EV_DoDoor (line,blazeOpen) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 110:

      if (EV_DoDoor (line,blazeClose) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 119:

      if (EV_DoFloor(line,raiseFloorToNearest) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 121:

      if (EV_DoPlat(line,blazeDWUS,0) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;
  ...
  G_SecretExitLevel ();
    ...
    case 125:
      ...
      if (!thing->player &&
          (EV_Teleport(line, side, thing) || (compatibility_level < boom_compatibility_compatibility)))
        line->special = 0;
      break;

    case 130:

      if (EV_DoFloor(line,raiseFloorTurbo) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;

    case 141:

      if (EV_DoCeiling(line,silentCrushAndRaise) || (compatibility_level < boom_compatibility_compatibility))
        line->special = 0;
      break;
    ...
    case 129:
      ...
      break;
# 1694 "c:/devl/prboom3ds/src/p_spec.c"
    default:
      if (!(compatibility_level < boom_compatibility_compatibility))
        switch (line->special)
        {
          ...
          case 243:
            ...
            if (EV_SilentLineTeleport(line, side, thing, 0))
              line->special = 0;
            break;

          case 262:
            if (EV_SilentLineTeleport(line, side, thing, 1))
              line->special = 0;
            break;

          case 264:
            if (!thing->player &&
                EV_SilentLineTeleport(line, side, thing, 1))
              line->special = 0;
            break;

          case 266:
            if (!thing->player &&
                EV_SilentLineTeleport(line, side, thing, 0))
              line->special = 0;
            break;
          ...
          case 268:
            if (!thing->player && EV_SilentTeleport(line, side, thing))
              line->special = 0;
            break;
# 1833 "c:/devl/prboom3ds/src/p_spec.c"
          case 147:
...
# 2003 "c:/devl/prboom3ds/src/p_spec.c"
void P_ShootSpecialLine
( mobj_t* thing,
  line_t* line )
{
...
# 2186 "c:/devl/prboom3ds/src/p_spec.c"
...
# 2306 "c:/devl/prboom3ds/src/p_spec.c"
...
void P_UpdateSpecials (void)
{
  ...
  if (levelFragLimit == 1)
  {
    ...
    for (k=0;k<4;k++)
    {
      ...
      if (fragcount >= levelFragLimitCount) exitflag = 1;
      if (exitflag == 1) break;
    }
    if (exitflag == 1)
      G_ExitLevel();
...
# 2412 "c:/devl/prboom3ds/src/p_spec.c"
  ...
  for (i=0; i<numlines; i++)
    switch (lines[i].special)
    {
      ...
      case 261:
        ...
        break;
# 2580 "c:/devl/prboom3ds/src/p_spec.c"
      case 271:
      case 272:
        for (s = -1; (s = P_FindSectorFromLineTag(lines+i,s)) >= 0;)
          sectors[s].sky = i | (0x80000000);
        break;
   }
}
# 2607 "c:/devl/prboom3ds/src/p_spec.c"
  ...
  switch (s->type)
    ...
    case sc_carry:
      ...
      waterheight = sec->heightsec != -1 &&
        ...
        sectors[sec->heightsec].floorheight : (-2147483647 - 1);

      for (node = sec->touching_thinglist; node; node = node->m_snext)
        if (!((thing = node->m_thing)->flags & (uint_64_t)(0x0000000000001000)) &&
            (!(thing->flags & (uint_64_t)(0x0000000000000200) || thing->z > height) ||
             thing->z < waterheight))
          {
...
# 2705 "c:/devl/prboom3ds/src/p_spec.c"
...
# 2732 "c:/devl/prboom3ds/src/p_spec.c"
...
# 2760 "c:/devl/prboom3ds/src/p_spec.c"
static void P_SpawnScrollers(void)
{
  int i;
  line_t *l = lines;
...
# 2780 "c:/devl/prboom3ds/src/p_spec.c"
...
# 2851 "c:/devl/prboom3ds/src/p_spec.c"
...
# 2869 "c:/devl/prboom3ds/src/p_spec.c"
void T_Friction(friction_t *f)
{
    ...
    if ((compatibility_level<=boom_compatibility_compatibility) || !variable_friction)
        return;
    ...
    if (!(sec->special & 0x100))
        return;
# 2896 "c:/devl/prboom3ds/src/p_spec.c"
    node = sec->touching_thinglist;
    while (node)
        {
        thing = node->m_thing;
        if (thing->player &&
            !(thing->flags & ((uint_64_t)(0x0000000000000200) | (uint_64_t)(0x0000000000001000))) &&
...
# 2967 "c:/devl/prboom3ds/src/p_spec.c"
static void P_SpawnFriction(void)
{
  int i;
  line_t *l = lines;
  ...
  for (i = 0; i < numsectors; i++)
    {
      sectors[i].friction = 0xE800;
      sectors[i].movefactor = 2048;
    }

  for (i = 0 ; i < numlines ; i++,l++)
    if (l->special == 223)
      {
        int length = P_AproxDistance(l->dx,l->dy)>>16;
        ...
        for (s = -1; (s = P_FindSectorFromLineTag(l,s)) >= 0 ; )
          {
# 3018 "c:/devl/prboom3ds/src/p_spec.c"
            if (!(compatibility_level < boom_compatibility_compatibility) && !(compatibility_level>=mbf_compatibility))
...
# 3083 "c:/devl/prboom3ds/src/p_spec.c"
...
# 3112 "c:/devl/prboom3ds/src/p_spec.c"
pusher_t* tmpusher;
...
static boolean PIT_PushThing(mobj_t* thing)
{
  ...
  if (!(compatibility_level>=mbf_compatibility) ?
      thing->player && !(thing->flags & ((uint_64_t)(0x0000000000001000) | (uint_64_t)(0x0000000000000200))) :
      (((thing)->health > 0 && (thing)->info->seestate) || thing->flags & (uint_64_t)(0x0000000000000004)) &&
      !(thing->flags & (uint_64_t)(0x0000000000001000)))
    {
      angle_t pushangle;
      fixed_t speed;
      ...
      speed = (tmpusher->magnitude -
               ((P_AproxDistance(thing->x - sx,thing->y - sy)
                 >>16)>>1))<<(16 -7 -1);
# 3139 "c:/devl/prboom3ds/src/p_spec.c"
      if (speed > 0 && (compatibility_level>=mbf_compatibility))
        {
          int x = (thing->x-sx) >> 16;
          int y = (thing->y-sy) >> 16;
...
void T_Pusher(pusher_t *p)
{
    ...
    if ((compatibility_level < boom_compatibility_compatibility) || !allow_pushers)
        return;
    ...
    if (!(sec->special & 0x200))
        return;
# 3203 "c:/devl/prboom3ds/src/p_spec.c"
    if (p->type == p_push)
        {
    ...
    for ( ; node ; node = node->m_snext)
        {
        thing = node->m_thing;
        if (!thing->player || (thing->flags & ((uint_64_t)(0x0000000000000200) | (uint_64_t)(0x0000000000001000))))
            continue;
        if (p->type == p_wind)
            {
            if (sec->heightsec == -1)
...
static void P_SpawnPushers(void)
{
    ...
    for (i = 0 ; i < numlines ; i++,l++)
        switch(l->special)
          ...
          case 224:
            for (s = -1; (s = P_FindSectorFromLineTag(l,s)) >= 0 ; )
                Add_Pusher(p_wind,l->dx,l->dy,((void *)0),s);
            break;
          case 225:
            for (s = -1; (s = P_FindSectorFromLineTag(l,s)) >= 0 ; )
                Add_Pusher(p_current,l->dx,l->dy,((void *)0),s);
            break;
          case 226:
            for (s = -1; (s = P_FindSectorFromLineTag(l,s)) >= 0 ; )
                {
