# 1 "c:/devl/prboom3ds/src/p_tick.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_tick.c"
# 34 "c:/devl/prboom3ds/src/p_tick.c"
...
# 35 "c:/devl/prboom3ds/src/p_tick.c" 2
...
# 36 "c:/devl/prboom3ds/src/p_tick.c" 2
...
# 37 "c:/devl/prboom3ds/src/p_tick.c" 2
...
# 38 "c:/devl/prboom3ds/src/p_tick.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_tick.c" 2
...
# 40 "c:/devl/prboom3ds/src/p_tick.c" 2

int leveltime;

static boolean newthinkerpresent;
# 55 "c:/devl/prboom3ds/src/p_tick.c"
...
void P_InitThinkers(void)
{
  ...
  thinkerclasscap[th_all].prev = thinkerclasscap[th_all].next = &thinkerclasscap[th_all];
}
# 78 "c:/devl/prboom3ds/src/p_tick.c"
void P_UpdateThinker(thinker_t *thinker)
{
  ...
  int class =
    ...
    (((mobj_t *) thinker)->flags & (uint_64_t)(0x0000000000400000) ||
     ((mobj_t *) thinker)->type == MT_SKULL) ?
    ((mobj_t *) thinker)->flags & (uint_64_t)0x0000000400000000ll ?
    th_friends : th_enemies : th_misc;

  {

    if ((th = thinker->cnext)!= ((void *)0))
...
void P_AddThinker(thinker_t* thinker)
{
  thinkerclasscap[th_all].prev->next = thinker;
  thinker->next = &thinkerclasscap[th_all];
  thinker->prev = thinkerclasscap[th_all].prev;
  thinkerclasscap[th_all].prev = thinker;

  thinker->references = 0;


  thinker->cnext = thinker->cprev = ((void *)0);
...
# 145 "c:/devl/prboom3ds/src/p_tick.c"
void P_RemoveThinkerDelayed(thinker_t *thinker)
{
...
# 179 "c:/devl/prboom3ds/src/p_tick.c"
void P_RemoveThinker(thinker_t *thinker)
{
...
thinker_t* P_NextThinker(thinker_t* th, th_class cl)
{
  ...
  return th == top ? ((void *)0) : th;
}
# 210 "c:/devl/prboom3ds/src/p_tick.c"
...
# 241 "c:/devl/prboom3ds/src/p_tick.c"
static void P_RunThinkers (void)
{
  for (currentthinker = thinkerclasscap[th_all].next;
       currentthinker != &thinkerclasscap[th_all];
...
{
  int i;
# 272 "c:/devl/prboom3ds/src/p_tick.c"
