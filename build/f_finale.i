# 1 "c:/devl/prboom3ds/src/f_finale.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/f_finale.c"
# 35 "c:/devl/prboom3ds/src/f_finale.c"
...
# 36 "c:/devl/prboom3ds/src/f_finale.c" 2
...
# 37 "c:/devl/prboom3ds/src/f_finale.c" 2
...
void V_FreeScreens();
# 38 "c:/devl/prboom3ds/src/f_finale.c" 2
...
# 39 "c:/devl/prboom3ds/src/f_finale.c" 2
...
extern int idmusnum;
# 40 "c:/devl/prboom3ds/src/f_finale.c" 2
...
# 41 "c:/devl/prboom3ds/src/f_finale.c" 2
...
# 42 "c:/devl/prboom3ds/src/f_finale.c" 2
# 1 "c:/devl/prboom3ds/src/f_finale.h" 1
# 46 "c:/devl/prboom3ds/src/f_finale.h"
...
# 43 "c:/devl/prboom3ds/src/f_finale.c" 2
...
# 63 "c:/devl/prboom3ds/src/f_finale.c"
...
{
  return midstage ? 0.01f : (midstage=acceleratestage) ?
    acceleratestage=0, 0.01f : 3;
}
# 212 "c:/devl/prboom3ds/src/f_finale.c"
void F_Ticker(void)
{
  int i;
  ...
  if (!finalestage)
    {
      float speed = (compatibility_level < boom_compatibility_compatibility) ? 3 : Get_TextSpeed();
      ...
      if (finalecount > strlen(finaletext)*speed +
        ...
        if (gamemode != commercial)
          ...
          if (!(compatibility_level < boom_compatibility_compatibility) && midstage)
            {
            next_level:
              if (gamemap == 30)
                F_StartCast();
...
# 269 "c:/devl/prboom3ds/src/f_finale.c"
...
# 270 "c:/devl/prboom3ds/src/f_finale.c" 2
...
static void F_TextWrite (void)
{
  ...
  break;
      ...
      V_DrawNumPatch(cx, cy, 0, hu_font[c].lumpnum, CR_RED, VPT_STRETCH);
      cx+=w;
    }
  }
}
...
static void F_CastPrint (const char* text)
{
  ...
  while (ch)
  {
    ...
    V_DrawNumPatch(cx, 180, 0, hu_font[c].lumpnum, CR_RED, VPT_STRETCH);
    cx+=w;
  }
}
...
void F_CastDrawer (void)
{
  ...
  V_DrawNumPatch(0,0,0,W_GetNumForName(bgcastcall),CR_RED,VPT_STRETCH);
  ...
  V_DrawNumPatch(160, 170, 0, lump+firstspritelump, CR_RED,
...
static void F_BunnyScroll (void)
{
...

  {
    ...
    if (scrolled <= 0) {
      V_DrawNumPatch(0,0,0,W_GetNumForName(pfub2),CR_RED,VPT_STRETCH);
    } else if (scrolled >= 320) {
      V_DrawNumPatch(0,0,0,W_GetNumForName(pfub1),CR_RED,VPT_STRETCH);
    } else {
      V_DrawNumPatch(320-scrolled,0,0,W_GetNumForName(pfub1),CR_RED,VPT_STRETCH);
      V_DrawNumPatch(-scrolled,0,0,W_GetNumForName(pfub2),CR_RED,VPT_STRETCH);
    }
  }
  ...
  if (finalecount < 1180)
  {
    ...
    V_DrawNumPatch((320-13*8)/2,(200-8*8)/2,0,W_GetNumForName("END0"),CR_RED,VPT_STRETCH);
    laststage = 0;
    return;
  }
  ...
  V_DrawNumPatch((320-13*8)/2,(200-8*8)/2,0,W_GetNumForName(name),CR_RED,VPT_STRETCH);
}
  ...
  else
  {
    switch (gameepisode)
    {
      ...
      case 1:
           ...
           break;
      case 2:
           V_DrawNumPatch(0,0,0,W_GetNumForName("VICTORY2"),CR_RED,VPT_STRETCH);
           break;
      case 3:
           F_BunnyScroll ();
           break;
      case 4:
           V_DrawNumPatch(0,0,0,W_GetNumForName("ENDPIC"),CR_RED,VPT_STRETCH);
           break;
    }
  }
}
