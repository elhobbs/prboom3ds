# 1 "c:/devl/prboom3ds/src/d_client.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/d_client.c"
# 42 "c:/devl/prboom3ds/src/d_client.c"
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\types.h" 1 3
# 20 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\types.h" 3
...
# 21 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\types.h" 2 3
...
# 43 "c:/devl/prboom3ds/src/d_client.c" 2
# 54 "c:/devl/prboom3ds/src/d_client.c"
...
# 55 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 56 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 57 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 60 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 61 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 62 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 63 "c:/devl/prboom3ds/src/d_client.c" 2

# 1 "c:/devl/prboom3ds/src/protocol.h" 1
# 37 "c:/devl/prboom3ds/src/protocol.h"
enum packet_type_e {
  PKT_INIT,
  PKT_SETUP,
  PKT_GO,
...
{ p->tic = (long int)(tic); p->type = t; p->reserved[0] = 0; p->reserved[1] = 0; }
...
inline static void RawToTic(ticcmd_t* dst, const void* src)
{
  ...
  dst->angleturn = (short int)(dst->angleturn);
  dst->consistancy = (short int)(dst->consistancy);
}
...
inline static void TicToRaw(void* dst, const ticcmd_t* src)
{
  ...
  ticcmd_t tmp = *src;
  tmp.angleturn = (short int)(tmp.angleturn);
  tmp.consistancy = (short int)(tmp.consistancy);
  memcpy(dst,&tmp,sizeof tmp);
}
# 65 "c:/devl/prboom3ds/src/d_client.c" 2
# 1 "c:/devl/prboom3ds/src/i_network.h" 1
# 52 "c:/devl/prboom3ds/src/i_network.h"
...
# 74 "c:/devl/prboom3ds/src/i_network.h"
extern size_t sentbytes, recvdbytes;
# 66 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 67 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 68 "c:/devl/prboom3ds/src/d_client.c" 2
# 1 "c:/devl/prboom3ds/src/i_video.h" 1
# 38 "c:/devl/prboom3ds/src/i_video.h"
...
void V_FreeScreens();
# 39 "c:/devl/prboom3ds/src/i_video.h" 2
...
# 69 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 70 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 71 "c:/devl/prboom3ds/src/d_client.c" 2
...
# 72 "c:/devl/prboom3ds/src/d_client.c" 2

static boolean server;
static int remotetic;
static int remotesend;
...
static boolean isExtraDDisplay = 0;

static void D_QuitNetGame (void);


doomcom_t* doomcom;
# 166 "c:/devl/prboom3ds/src/d_client.c"
void D_InitNetGame (void)
{
  int i;

  doomcom = Z_Malloc(sizeof *doomcom, PU_STATIC, ((void *)0));
...
# 372 "c:/devl/prboom3ds/src/d_client.c"
void D_BuildNewTiccmds(void)
{
    ...
    {
      I_StartTic();
      if (maketic - gametic > 12/2) break;
      G_BuildTiccmd(&localcmds[maketic%12]);
      maketic++;
    }
}
# 457 "c:/devl/prboom3ds/src/d_client.c"
void TryRunTics (void)
{
  int runtics;
...
# 489 "c:/devl/prboom3ds/src/d_client.c"
        M_Ticker(); return;
      }

      {
        WasRenderedInTryRunTics = 1;
