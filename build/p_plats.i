# 1 "c:/devl/prboom3ds/src/p_plats.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/p_plats.c"
# 34 "c:/devl/prboom3ds/src/p_plats.c"
...
# 35 "c:/devl/prboom3ds/src/p_plats.c" 2
...
# 36 "c:/devl/prboom3ds/src/p_plats.c" 2
...
# 37 "c:/devl/prboom3ds/src/p_plats.c" 2
...
# 38 "c:/devl/prboom3ds/src/p_plats.c" 2
...
# 39 "c:/devl/prboom3ds/src/p_plats.c" 2
...
extern int idmusnum;
# 40 "c:/devl/prboom3ds/src/p_plats.c" 2
...
# 41 "c:/devl/prboom3ds/src/p_plats.c" 2

platlist_t *activeplats;
# 55 "c:/devl/prboom3ds/src/p_plats.c"
...
# 180 "c:/devl/prboom3ds/src/p_plats.c"
int EV_DoPlat
( line_t* line,
  plattype_e type,
  int amount )
...
# 342 "c:/devl/prboom3ds/src/p_plats.c"
...
# 369 "c:/devl/prboom3ds/src/p_plats.c"
int EV_StopPlat(line_t* line)
{
  ...
  for (pl=activeplats; pl; pl=pl->next)
  {
    ...
    if (plat->status != in_stasis && plat->tag == line->tag)
    {
      plat->oldstatus = plat->status;
      plat->status = in_stasis;
      plat->thinker.function = ((void *)0);
    }
  }
  return 1;
}
# 393 "c:/devl/prboom3ds/src/p_plats.c"
...
# 412 "c:/devl/prboom3ds/src/p_plats.c"
...
# 429 "c:/devl/prboom3ds/src/p_plats.c"
