...
.Ltext0:
	...
	.align	2
	.global	wipe_StartScreen
	.type	wipe_StartScreen, %function
wipe_StartScreen:
.LFB7:
	.file 1 "c:/devl/prboom3ds/src/f_wipe.c"
	.loc 1 157 0
	.cfi_startproc
...
.LFE9:
	...
	.align	2
	.set	.LANCHOR0,. + 0
	.type	wipe_scr_start, %object
	.size	wipe_scr_start, 28
wipe_scr_start:
	.space	28
	.type	wipe_scr_end, %object
	.size	wipe_scr_end, 28
wipe_scr_end:
	.space	28
	.type	go.8165, %object
	.size	go.8165, 4
go.8165:
	.space	4
	.type	wipe_scr, %object
	.size	wipe_scr, 28
wipe_scr:
	.space	28
	.type	y_lookup, %object
	.size	y_lookup, 1600
y_lookup:
	.space	1600
	.text
.Letext0:
	...
	.file 7 "c:/devl/prboom3ds/src/v_video.h"
	.file 8 "c:/devl/prboom3ds/src/m_random.h"
...
.LASF1339:
	.ascii	"c:/devl/prboom3ds/src/f_wipe.c\000"
.LASF226:
