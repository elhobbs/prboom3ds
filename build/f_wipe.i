# 1 "c:/devl/prboom3ds/src/f_wipe.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/f_wipe.c"
# 40 "c:/devl/prboom3ds/src/f_wipe.c"
...
# 41 "c:/devl/prboom3ds/src/f_wipe.c" 2
...
# 42 "c:/devl/prboom3ds/src/f_wipe.c" 2
# 1 "c:/devl/prboom3ds/src/i_video.h" 1
# 37 "c:/devl/prboom3ds/src/i_video.h"
...
# 38 "c:/devl/prboom3ds/src/i_video.h" 2
...
# 42 "c:/devl/prboom3ds/src/r_defs.h"
...
# 43 "c:/devl/prboom3ds/src/r_defs.h" 2
...
# 47 "c:/devl/prboom3ds/src/r_defs.h" 2


# 1 "c:/devl/prboom3ds/src/p_mobj.h" 1
# 38 "c:/devl/prboom3ds/src/p_mobj.h"
...
# 39 "c:/devl/prboom3ds/src/p_mobj.h" 2
...
# 45 "c:/devl/prboom3ds/src/info.h"
typedef enum
{
  SPR_TROO,
  SPR_SHTG,
...
# 52 "c:/devl/prboom3ds/src/p_mobj.h" 2
...
# 50 "c:/devl/prboom3ds/src/r_defs.h" 2
...
# 39 "c:/devl/prboom3ds/src/r_state.h"
...
# 53 "c:/devl/prboom3ds/src/d_player.h"
...
# 40 "c:/devl/prboom3ds/src/r_state.h" 2
# 1 "c:/devl/prboom3ds/src/r_data.h" 1
...
# 43 "c:/devl/prboom3ds/src/f_wipe.c" 2
...
static int wipe_initMelt(int ticks)
{
  ...
  y_lookup[0] = -(P_Random(pr_misc)%16);
  for (i=1;i<SCREENWIDTH;i++)
    {
      int r = (P_Random(pr_misc)%3) - 1;
...
static int wipe_exitMelt(int ticks)
{
  ...
  screens[2] = wipe_scr_start;
  screens[3] = wipe_scr_end;
  return 0;
}
...
int wipe_StartScreen(void)
{
  ...
  wipe_scr_start.not_on_heap = 0;
  V_AllocScreen(&wipe_scr_start);
  screens[2] = wipe_scr_start;
  V_CopyRect(0, 0, 0, SCREENWIDTH, SCREENHEIGHT, 0, 0, 2, VPT_NONE );
  return 0;
}
...
int wipe_EndScreen(void)
{
  ...
  wipe_scr_end.not_on_heap = 0;
  V_AllocScreen(&wipe_scr_end);
  screens[3] = wipe_scr_end;
  V_CopyRect(0, 0, 0, SCREENWIDTH, SCREENHEIGHT, 0, 0, 3, VPT_NONE);
  V_CopyRect(0, 0, 2, SCREENWIDTH, SCREENHEIGHT, 0, 0, 0 , VPT_NONE);
  return 0;
}
