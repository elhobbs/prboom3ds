# 1 "c:/devl/prboom3ds/arm9/source/ds_sys.c"
...
# 2 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
# 3 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
# 4 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
# 5 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
# 6 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2

# 1 "c:/devl/prboom3ds/arm9/include/config.h" 1
# 8 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
# 1 "c:/devl/prboom3ds/src/doomtype.h" 1
# 65 "c:/devl/prboom3ds/src/doomtype.h"
...
# 9 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
# 10 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
# 11 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
# 1 "c:/devl/prboom3ds/src/i_sound.h" 1
# 37 "c:/devl/prboom3ds/src/i_sound.h"
...
# 38 "c:/devl/prboom3ds/src/i_sound.h" 2
...
# 12 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
# 13 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
# 1 "c:/devl/prboom3ds/src/r_fps.h" 1
# 38 "c:/devl/prboom3ds/src/r_fps.h"
# 1 "c:/devl/prboom3ds/src/doomstat.h" 1
# 39 "c:/devl/prboom3ds/src/r_fps.h" 2
...
# 14 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
# 15 "c:/devl/prboom3ds/arm9/source/ds_sys.c" 2
...
int I_Filelength(FILE *handle)
{
 ...
 if (fstat(handle, &fileinfo) == -1)
  I_Error("I_Filelength: %s", strerror((*__errno())));
...
char* I_FindFile(const char* wfname, const char* ext)
{
 ...
 for (i = 0; i<8; i++) {
  ...
  p = Z_Malloc((d ? strlen(d) : 0) + (s ? strlen(s) : 0) + pl,PU_STATIC,0);
...
int I_GetTime_RealTime(void)
{
 int t = GetTicks();
 int i = t*(35 / 5) / 200;
 ms_to_next_tick = (i + 1) * 200 / (35 / 5) - t;
 if (ms_to_next_tick > 1000 / 35 || ms_to_next_tick<1) ms_to_next_tick = 1;
 return i;
}
...
fixed_t I_GetTimeFrac(void)
{
 ...
 {
  frac = (fixed_t)((now - tic_vars.start + displaytime) * (1<<16) / tic_vars.step);
  if (frac < 0)
   frac = 0;
  if (frac > (1<<16))
   frac = (1<<16);
...
const char *I_DoomExeDir(void)
{
 ...
 static const char current_dir_dummy[] = { "sdmc:/" };
 base = Z_Malloc(4096,PU_STATIC,0);
 if (!getcwd(base, 4096))
  strcpy(base, current_dir_dummy);
 printf("base dir: %s\n",base);
# 234 "c:/devl/prboom3ds/arm9/source/ds_sys.c"
 return base;
}
