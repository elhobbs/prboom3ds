# 1 "c:/devl/prboom3ds/arm11/source/file.c"
...
# 9 "c:/devkitPro/libctru/include/3ds.h" 2
...
# 2 "c:/devl/prboom3ds/arm11/source/file.c" 2
...
# 3 "c:/devl/prboom3ds/arm11/source/file.c" 2
...
# 4 "c:/devl/prboom3ds/arm11/source/file.c" 2
...
# 5 "c:/devl/prboom3ds/arm11/source/file.c" 2
# 1 "c:\\devkitpro\\devkitarm\\lib\\gcc\\arm-none-eabi\\4.9.2\\include\\stddef.h" 1 3 4
# 6 "c:/devl/prboom3ds/arm11/source/file.c" 2

# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\errno.h" 1 3
...
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\errno.h" 1 3
# 15 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\errno.h" 3
...
# 10 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\errno.h" 2 3
# 8 "c:/devl/prboom3ds/arm11/source/file.c" 2
...
# 10 "c:/devl/prboom3ds/arm11/source/file.c" 2
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\statvfs.h" 1 3
# 14 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\statvfs.h" 3
struct statvfs {
...
# 11 "c:/devl/prboom3ds/arm11/source/file.c" 2
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\iosupport.h" 1 3
# 10 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\iosupport.h" 3
# 1 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\reent.h" 1 3
# 99 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\reent.h" 3
# 1 "c:\\devkitpro\\devkitarm\\lib\\gcc\\arm-none-eabi\\4.9.2\\include\\stddef.h" 1 3 4
# 100 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\reent.h" 2 3
...
struct timeval;
struct timezone;
# 140 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\reent.h" 3
...
# 11 "c:\\devkitpro\\devkitarm\\arm-none-eabi\\include\\sys\\iosupport.h" 2 3
...
# 12 "c:/devl/prboom3ds/arm11/source/file.c" 2
...
# 13 "c:/devl/prboom3ds/arm11/source/file.c" 2
...
int _FAT_open_r (struct _reent *r, void *fileStruct, const char *path, int flags, int mode) {
 ...
 ret=FSUSER_OpenFile(((void *)0), &file->handle, fsptr->sdmcArchive, FS_makePath(PATH_CHAR, tmpStr), sdflags, 0);
...
int _FAT_stat_r (struct _reent *r, const char *path, struct stat *st) {
 ...
 ret = FSUSER_OpenFile(((void *)0), &handle, fsptr->sdmcArchive, FS_makePath(PATH_CHAR, path), (1<<0), 0);
...
DIR_ITER* _FAT_diropen_r(struct _reent *r, DIR_ITER *dirState, const char *path) {
 ...
 if (FSUSER_OpenDirectory(((void *)0), &state->handle, fsptr->sdmcArchive, dirPath)) {
  r->_errno = 2;
  return ((void *)0);
 }
...
int _FAT_dirnext_r (struct _reent *r, DIR_ITER *dirState, char *filename, struct stat *filestat) {
 ...
 if (ret == 0)
 {
  ...
  if (state->entry_data.isDirectory)
   filestat->st_mode = 0040000;
  else
   filestat->st_mode = 0100000;
...
_Bool SD_init () {
 ...
 FSUSER_OpenArchive(((void *)0), &FS_ptr.sdmcArchive);
