...
.Ltext0:
	...
	.align	2
	.global	P_ActivateInStasis
	.type	P_ActivateInStasis, %function
P_ActivateInStasis:
.LFB6:
	.file 1 "c:/devl/prboom3ds/src/p_plats.c"
	.loc 1 343 0
	.cfi_startproc
...
.LBB4:
	...
	cmp	r1, #7
	.loc 1 351 0
	ldrb	r1, [r2, #49]	@ zero_extendqisi2
	.loc 1 354 0
	str	ip, [r2, #8]
	.loc 1 351 0
	clzeq	r1, r1
...
.LVL37:
	...
	add	r0, r10, #52
	.loc 1 245 0
	strh	r3, [r10, #190]	@ movhi
	.loc 1 247 0
	strh	r3, [r10, #192]	@ movhi
	.loc 1 249 0
	mov	r1, #22
	bl	S_StartSound
.LVL38:
...
.LFE4:
	...
	.align	2
	.global	P_RemoveAllActivePlats
	.type	P_RemoveAllActivePlats, %function
...
.L101:
	...
	.cfi_endproc
.LFE10:
	.size	P_RemoveAllActivePlats, .-P_RemoveAllActivePlats
	.comm	activeplats,4,4
.Letext0:
...
.LASF1879:
	.ascii	"c:/devl/prboom3ds/src/p_plats.c\000"
.LASF1081:
	.ascii	"S_AMMO\000"
.LASF1573:
