# 1 "c:/devl/prboom3ds/src/hu_lib.c"
# 1 "c:\\devl\\prboom3ds\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/devl/prboom3ds/src/hu_lib.c"
# 34 "c:/devl/prboom3ds/src/hu_lib.c"
...
# 35 "c:/devl/prboom3ds/src/hu_lib.c" 2
...
# 36 "c:/devl/prboom3ds/src/hu_lib.c" 2
...
void V_FreeScreens();
# 37 "c:/devl/prboom3ds/src/hu_lib.c" 2
...
# 39 "c:/devl/prboom3ds/src/hu_lib.c" 2
...
# 40 "c:/devl/prboom3ds/src/hu_lib.c" 2
...
# 41 "c:/devl/prboom3ds/src/hu_lib.c" 2
...
# 42 "c:/devl/prboom3ds/src/hu_lib.c" 2
...
# 70 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_clearTextLine(hu_textline_t* t)
{
  t->linelen =
    t->len = 0;
...
# 87 "c:/devl/prboom3ds/src/hu_lib.c"
...
# 107 "c:/devl/prboom3ds/src/hu_lib.c"
...
# 136 "c:/devl/prboom3ds/src/hu_lib.c"
...
# 155 "c:/devl/prboom3ds/src/hu_lib.c"
  ...
  boolean drawcursor )
{
  ...
  for (i=0;i<l->len;i++)
  {
    c = __extension__ ({ __typeof__ (l->l[i]) __x = (l->l[i]); ((((__ctype_ptr__+sizeof(""[__x]))[(int)(__x)])&(01|02))==02) ? (int) __x - 'a' + 'A' : (int) __x;});
    ...
    else if (c != ' ' && c >= l->sc && c <= 127)
    {
      ...
      V_DrawNumPatch(x, y, 0, l->f[c - l->sc].lumpnum, l->cm, VPT_TRANS | VPT_STRETCH);
      x += w;
    }
    else
    {
  ...
  if (drawcursor && x + l->f['_' - l->sc].width <= 320)
  {


    V_DrawNumPatch(x, y, 0, l->f['_' - l->sc].lumpnum, CR_RED, VPT_NONE | VPT_STRETCH);
  }
}
# 220 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_eraseTextLine(hu_textline_t* l)
{
  int lh;
  int y;
...
# 264 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_initSText
( hu_stext_t* s,
  int x,
  int y,
...
# 301 "c:/devl/prboom3ds/src/hu_lib.c"
...
# 325 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_addMessageToSText(hu_stext_t* s, const char* prefix, const char* msg)
{
...
# 344 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_drawSText(hu_stext_t* s)
{
  int i, idx;
  hu_textline_t *l;
...
# 374 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_eraseSText(hu_stext_t* s)
{
  int i;
...
# 405 "c:/devl/prboom3ds/src/hu_lib.c"
...
# 442 "c:/devl/prboom3ds/src/hu_lib.c"
...
# 464 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_addMessageToMText(hu_mtext_t* m, const char* prefix, const char* msg)
{
...
# 484 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_drawMBg
( int x,
  int y,
  int w,
...
)
{
  ...
  V_DrawNumPatch(x, y, 0, bgp[0].lumpnum, CR_RED, VPT_STRETCH);
  for (j=x+xs;j<x+w-xs;j+=xs)
    V_DrawNumPatch(j, y, 0, bgp[1].lumpnum, CR_RED, VPT_STRETCH);
  V_DrawNumPatch(j, y, 0, bgp[2].lumpnum, CR_RED, VPT_STRETCH);


  for (i=y+ys;i<y+h-ys;i+=ys)
  {
    V_DrawNumPatch(x, i, 0, bgp[3].lumpnum, CR_RED, VPT_STRETCH);
    for (j=x+xs;j<x+w-xs;j+=xs)
      V_DrawNumPatch(j, i, 0, bgp[4].lumpnum, CR_RED, VPT_STRETCH);
    V_DrawNumPatch(j, i, 0, bgp[5].lumpnum, CR_RED, VPT_STRETCH);
  }


  V_DrawNumPatch(x, i, 0, bgp[6].lumpnum, CR_RED, VPT_STRETCH);
  for (j=x+xs;j<x+w-xs;j+=xs)
    V_DrawNumPatch(j, i, 0, bgp[7].lumpnum, CR_RED, VPT_STRETCH);
  V_DrawNumPatch(j, i, 0, bgp[8].lumpnum, CR_RED, VPT_STRETCH);
}
# 527 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_drawMText(hu_mtext_t* m)
{
  int i, idx, y;
  hu_textline_t *l;
...
# 570 "c:/devl/prboom3ds/src/hu_lib.c"
...
# 606 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_eraseMText(hu_mtext_t* m)
{
  int i;
...
# 635 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_initIText
( hu_itext_t* it,
  int x,
  int y,
...
# 660 "c:/devl/prboom3ds/src/hu_lib.c"
static void HUlib_delCharFromIText(hu_itext_t* it)
{
  if (it->l.len != it->lm)
    HUlib_delCharFromTextLine(&it->l);
}
# 674 "c:/devl/prboom3ds/src/hu_lib.c"
static void HUlib_eraseLineFromIText(hu_itext_t* it)
{
  while (it->lm != it->l.len)
    HUlib_delCharFromTextLine(&it->l);
}
# 689 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_resetIText(hu_itext_t* it)
{
  it->lm = 0;
    HUlib_clearTextLine(&it->l);
}
# 704 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_addPrefixToIText
( hu_itext_t* it,
  char* str )
{
...
# 721 "c:/devl/prboom3ds/src/hu_lib.c"
boolean HUlib_keyInIText
( hu_itext_t* it,
  unsigned char ch )
{
...
# 744 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_drawIText(hu_itext_t* it)
{
...
# 761 "c:/devl/prboom3ds/src/hu_lib.c"
void HUlib_eraseIText(hu_itext_t* it)
{
  if (it->laston && !*it->on)
    it->l.needsupdate = 4;
