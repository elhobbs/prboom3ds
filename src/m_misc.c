...
default_t defaults[] =
{
  ...
  {"screen_width",{&desired_screenwidth},{400}, 400, MAX_SCREENWIDTH,
   def_int,ss_none},
  {"screen_height",{&desired_screenheight},{240},240,MAX_SCREENHEIGHT,
   def_int,ss_none},
