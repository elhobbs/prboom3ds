...
const char *const standard_iwads[]=
{
  ...
  "freedoom1.wad", /* wart@kobold.org:  added freedoom for Fedora Extras */
...
const char *const standard_iwads_name[] =
{
	...
	"Doom",
	"Shareware Doom",
	"Ultimate Doom", /* CPhipps - alow doomu.wad */
	"Free Doom Phase 1", /* wart@kobold.org:  added freedoom for Fedora Extras */
	"Free Doom Phase 2", /* wart@kobold.org:  added freedoom for Fedora Extras */
};
...
static char* ds_game_choose() {
	...
	while (true) {
		...
		if (pressed & KEY_UP)
		{
			...
			if (pos < 0)
			{
				pos = wads_found_cnt-1;		// Wrap around to bottom of list
			}
		}
		if (pressed & KEY_DOWN)
		{
